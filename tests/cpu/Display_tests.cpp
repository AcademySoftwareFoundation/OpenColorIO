...
colorspaces:
  - !<ColorSpace>
    ...
    {
        // Test that Config::AreViewsEqual works for a matching (display, view) pair across separate configs.
        ...
        OCIO_CHECK_ASSERT(config2->isViewShared("sRGB", "view"));

        OCIO_CHECK_ASSERT(OCIO::Config::AreViewsEqual(config1, config2, "sRGB", "view"));
...

    {
        ...
        OCIO_CHECK_ASSERT(!config1->isViewShared("Raw", "Raw"));
        ...
        OCIO_CHECK_ASSERT(!config2->isViewShared("Raw", "Raw"));

        OCIO_CHECK_ASSERT(OCIO::Config::AreViewsEqual(config1, config2, "Raw", "Raw"));
    }

    {
        // Test that Config::AreViewsEqual works for a matching (display, view) pair across separate configs, even
        ...
        OCIO_CHECK_ASSERT(config1->isViewShared("sRGB", "sview1"));

        // Inactive (display, view) pair where the view is a reference to a shared view.
        OCIO_CHECK_EQUAL(2, config2->getNumViews(OCIO::VIEW_SHARED, "sRGB"));
        OCIO_CHECK_EQUAL(std::string("view"), config2->getView(OCIO::VIEW_SHARED, "sRGB", 0));
        OCIO_CHECK_EQUAL(std::string("sview1"), config2->getView(OCIO::VIEW_SHARED, "sRGB", 1));
        OCIO_CHECK_ASSERT(config2->isViewShared("sRGB", "sview1"));

        OCIO_CHECK_ASSERT(OCIO::Config::AreViewsEqual(config1, config2, "sRGB", "sview1"));
    }

    {
        // Check that hasView method works if (display, view) pair exists regardless of whether the display or view
        ...
        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "Raw"   )); // Active display has inactive view (display-defined).
        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "view"  )); // Active display has active view (display-defined).
        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "sview1")); // Active display has active view (shared).
        OCIO_CHECK_ASSERT(cfg1->hasView("Raw" , "Raw"   )); // Inactive display has inactive view (display-defined).
        ...
        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "sview1")); // Inactive display has active view (shared).
        ...
        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB" , "Raw"  )); // Inactive display has active view (display-defined).
        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "sview1")); // Inactive display has inactive view (shared).

        OCIO_CHECK_NO_THROW(cfg1->setActiveDisplays("sRGB"));
        OCIO_CHECK_EQUAL(1, cfg1->getNumDisplays());
        OCIO_CHECK_EQUAL(std::string("sRGB"), cfg1->getDefaultDisplay());

        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "sview1")); // Active display has inactive view (shared).
    }

    {
        ...
        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "Raw"));
        OCIO_CHECK_ASSERT(OCIO::Config::AreViewsEqual(config1, cfg1, "sRGB", "Raw"));
...

    {
        ...
        OCIO_CHECK_ASSERT(cfg2->hasView("Raw", "Raw"));
        OCIO_CHECK_ASSERT(OCIO::Config::AreViewsEqual(config2, cfg2, "Raw", "Raw"));
...

    {
        ...
        OCIO_CHECK_ASSERT(cfg1->isViewShared("sRGB", "sview1"));

        OCIO_CHECK_ASSERT(cfg1->hasView("sRGB", "sview1"));
        ...
        OCIO_CHECK_ASSERT(cfg1->isViewShared(nullptr, "sview1"));

        OCIO_CHECK_ASSERT(!cfg1->hasView("sRGB", "sview1"));

        // When display name is null, hasView will only check config level shared views.
        OCIO_CHECK_ASSERT(cfg1->hasView(nullptr, "sview1"));
    }
}
...
colorspaces:
  - !<ColorSpace>
    ...
    {
        // Test that Config::AreVirtualViewsEqual works for a matching virtual view pair across separate configs.
        ...
        OCIO_CHECK_ASSERT(OCIO::Config::AreVirtualViewsEqual(config1, config2, viewName1));
    }
    {
    ...
    }
    {
        ...
        OCIO_CHECK_ASSERT(config1->isVirtualViewShared("Film"));

        OCIO_REQUIRE_EQUAL(2, cfg->getVirtualDisplayNumViews(OCIO::VIEW_SHARED));
        OCIO_CHECK_ASSERT(cfg->hasVirtualView("Film"));
        OCIO_CHECK_ASSERT(cfg->isVirtualViewShared("Film"));

        OCIO_CHECK_ASSERT(OCIO::Config::AreVirtualViewsEqual(config1, cfg, "Film"));

        // Check against another config where the virtual view is display-defined.
        OCIO_CHECK_ASSERT(OCIO::Config::AreVirtualViewsEqual(config2, cfg, "Film"));
    ...
    }
    {
        ...
        OCIO_CHECK_ASSERT(!config2->isVirtualViewShared("Film"));   // Confirm display-defined

        OCIO_REQUIRE_EQUAL(2, cfg->getVirtualDisplayNumViews(OCIO::VIEW_DISPLAY_DEFINED));
        OCIO_CHECK_ASSERT(cfg->hasVirtualView("Film"));
        OCIO_CHECK_ASSERT(!cfg->isVirtualViewShared("Film"));       // Confirm display-defined
