...
class GradingHueCurveTransformTest(unittest.TestCase):
    ...
    def test_contructor(self):
        ...
        self.assertEqual(gct.getDrawCurveOnly(), False)
    ...
    def test_misc(self):
        ...
        self.assertEqual(gct.getBypassLinToLog(), True)
        self.assertEqual(gct.getDrawCurveOnly(), False)
        gct.setDrawCurveOnly(True)
        self.assertEqual(gct.getDrawCurveOnly(), True)
        self.assertEqual(gct.getDirection(), OCIO.TRANSFORM_DIR_FORWARD)
