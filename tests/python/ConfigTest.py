...
"""
    ...
    def test_find_color_space_for_id(self):
        ...
        # "local:foo" is resolved via the plain one-namespace-stripped lookup, not the
        # local-mode config-name check.
        self.assertEqual(cfg.findColorSpaceForID('local:foo').getName(), 'foo')
