...
"""
    ...
    def test_create_builtin_config(self):
        ...
        cgConfigName = "cg-config-v2.0.0_aces-v1.3_ocio-v2.3"
        studioConfigName = "studio-config-v2.0.0_aces-v1.3_ocio-v2.3"
        defaultName = "default"
...
"""
    ...
    def test_resolve_config(self):
        defaultBuiltinConfig = "ocio://cg-config-v2.0.0_aces-v1.3_ocio-v2.3"
        cgLatestBuiltinConfig = "ocio://cg-config-v2.0.0_aces-v1.3_ocio-v2.3"
        studioLatestBuiltinConfig = "ocio://studio-config-v2.0.0_aces-v1.3_ocio-v2.3"
    ...
    def test_inactive_colorspaces(self):
      ...
      # Test existing colorspaces from cg-config-v2.0.0_aces-v1.3_ocio-v2.3. 
