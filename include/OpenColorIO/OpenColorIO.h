...
public:
    ...
    // dynamic properties of the requested type.  Throws if the requested property is
    // not found.  Note that if the processor contains several ops that support the
    // requested property, only ones for which dynamic has been enabled will be controlled.
    //
    // .. note::
