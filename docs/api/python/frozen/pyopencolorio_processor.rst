...
.. py:class:: Processor
   ...
   :canonical: PyOpenColorIO.Processor

   The *:ref:`Processor`* represents a specific color transformation which is the result of :ref:`getProcessor`.
...
.. py:class:: TransformFormatMetadataIterator
   ...
   :canonical: PyOpenColorIO.Processor.TransformFormatMetadataIterator
