...
using ViewTransformCategoryIterator = PyIterator<ViewTransformRcPtr, IT_VIEW_TRANSFORM_CATEGORY>;
...
void bindPyViewTransform(py::module & m)
{
    ...
    auto clsViewTransform = py::class_<ViewTransform, ViewTransformRcPtr>(m.attr("ViewTransform"));

    auto clsViewTransformCategoryIterator = py::class_<ViewTransformCategoryIterator>(
        clsViewTransform,
    ...
    clsViewTransform
        ...
        .def(
            "__deepcopy__",
            [](const ConstViewTransformRcPtr & self, py::dict) {
                return self->createEditableCopy();
            },
            "memo"_a)

        .def("getName", &ViewTransform::getName, DOC(ViewTransform, getName))
        .def("setName", &ViewTransform::setName, "name"_a, DOC(ViewTransform, setName))
        .def("getFamily", &ViewTransform::getFamily, DOC(ViewTransform, getFamily))
        .def("setFamily", &ViewTransform::setFamily, "family"_a, DOC(ViewTransform, setFamily))
        .def("getDescription", &ViewTransform::getDescription, DOC(ViewTransform, getDescription))
        .def(
            "setDescription",
            &ViewTransform::setDescription,
            "description"_a,
            DOC(ViewTransform, setDescription))
        .def(
            "getInterchangeAttribute",
            &ViewTransform::getInterchangeAttribute,
            "attrName"_a,
            DOC(ViewTransform, getInterchangeAttribute))
        .def(
            "setInterchangeAttribute",
            &ViewTransform::setInterchangeAttribute,
            "attrName"_a,
            "attrValue"_a,
            DOC(ViewTransform, setInterchangeAttribute))
        .def(
            "getInterchangeAttributes",
            &ViewTransform::getInterchangeAttributes,
            DOC(ViewTransform, getInterchangeAttributes))
        .def(
            "hasCategory",
            &ViewTransform::hasCategory,
            "category"_a,
            DOC(ViewTransform, hasCategory))
        .def(
            "addCategory",
            &ViewTransform::addCategory,
            "category"_a,
            DOC(ViewTransform, addCategory))
        .def(
            "removeCategory",
            &ViewTransform::removeCategory,
            "category"_a,
            DOC(ViewTransform, removeCategory))
        .def(
            "getCategories",
            [](ViewTransformRcPtr & self) { return ViewTransformCategoryIterator(self); })
        .def(
            "clearCategories",
            &ViewTransform::clearCategories,
            DOC(ViewTransform, clearCategories))
        .def(
            "getReferenceSpaceType",
            &ViewTransform::getReferenceSpaceType,
    ...
    clsViewTransformCategoryIterator
        .def(
            "__len__",
            [](ViewTransformCategoryIterator & it) { return it.m_obj->getNumCategories(); })
        .def(
            "__getitem__",
            [](ViewTransformCategoryIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumCategories());
                return it.m_obj->getCategory(i);
            })
        .def(
            "__iter__",
            [](ViewTransformCategoryIterator & it) -> ViewTransformCategoryIterator & {
                return it;
            })
