...
void bindPyProcessor(py::module & m)
{
    auto cls = py::class_<Processor, ProcessorRcPtr /* holder */>(m, "Processor", DS(Processor))
        ...
        .def("hasChannelCrosstalk", &Processor::hasChannelCrosstalk, DS(Processor, hasChannelCrosstalk))
        .def("getCacheID", &Processor::getCacheID, DS(Processor, getCacheID))
        .def("getProcessorMetadata", &Processor::getProcessorMetadata, DS(Processor, getProcessorMetadata))
        ...
        .def("createGroupTransform", &Processor::createGroupTransform, DS(Processor, createGroupTransform))
        ...
        .def("write", [](ProcessorRcPtr & self, const std::string & formatName) 
            {
             ...
             DS(Processor, write),
             "formatName"_a)
        .def("getDynamicProperty", &Processor::getDynamicProperty, DS(Processor, getDynamicProperty), "type"_a)
        .def("hasDynamicProperty", &Processor::hasDynamicProperty, DS(Processor, hasDynamicProperty), "type"_a)
