...
{
    // OpenColorIO
    py::class_<Baker, BakerRcPtr /* holder */>(m, "Baker", DOC(Baker));

    py::class_<PyBuiltinConfigRegistry>(m, "BuiltinConfigRegistry", DOC(BuiltinConfigRegistry));

    py::class_<ColorSpace, ColorSpaceRcPtr /* holder */>(m, "ColorSpace", DOC(ColorSpace));
    ...
    py::class_<Config, ConfigRcPtr /* holder */>(m, "Config", DOC(Config));

    py::class_<Context, ContextRcPtr /* holder */>(m, "Context", DOC(Context));

    py::class_<CPUProcessor, CPUProcessorRcPtr /* holder */>(m, "CPUProcessor", DOC(CPUProcessor));

    py::class_<FileRules, FileRulesRcPtr /* holder */>(m, "FileRules", DOC(FileRules));

    py::class_<GPUProcessor, GPUProcessorRcPtr /* holder */>(m, "GPUProcessor", DOC(GPUProcessor));
    ...
    py::class_<PyImageDesc>(m, "ImageDesc", DOC(ImageDesc));
    ...
    py::class_<Look, LookRcPtr /* holder */>(m, "Look", DOC(Look));
    ...
    py::class_<Processor, ProcessorRcPtr /* holder */>(m, "Processor", DOC(Processor));
    ...
    py::class_<PySystemMonitors>(m, "SystemMonitors", DOC(SystemMonitors));

    py::class_<ViewingRules, ViewingRulesRcPtr /* holder */>(m, "ViewingRules", DOC(ViewingRules));
    ...
    py::class_<PyDynamicProperty>(m, "DynamicProperty", DOC(DynamicProperty));

    py::class_<FormatMetadata>(m, "FormatMetadata", DOC(FormatMetadata));

    py::class_<GradingRGBM>(m, "GradingRGBM", DOC(GradingRGBM));

    py::class_<GradingPrimary>(m, "GradingPrimary", DOC(GradingPrimary));

    py::class_<GradingRGBMSW>(m, "GradingRGBMSW", DOC(GradingRGBMSW));

    py::class_<GradingTone>(m, "GradingTone", DOC(GradingTone));

    py::class_<GradingControlPoint>(m, "GradingControlPoint", DOC(GradingControlPoint));
    ...
    py::class_<Transform, TransformRcPtr /* holder */>(m, "Transform", DOC(Transform));

    py::class_<AllocationTransform, AllocationTransformRcPtr /* holder */, Transform /* base */>(
        m,
        "AllocationTransform",
    ...
    py::class_<ColorSpaceTransform, ColorSpaceTransformRcPtr /* holder */, Transform /* base */>(
        m,
        "ColorSpaceTransform",
        DOC(ColorSpaceTransform));

    py::class_<DisplayViewTransform, DisplayViewTransformRcPtr /* holder */, Transform /* base */>(
        m,
    ...
    py::class_<
        ...
        Transform /* base */>(m, "ExponentWithLinearTransform", DOC(ExponentWithLinearTransform));

    py::class_<
        ExposureContrastTransform,
        ExposureContrastTransformRcPtr /* holder */,
        Transform /* base */>(m, "ExposureContrastTransform", DOC(ExposureContrastTransform));
    ...
    py::class_<
        ...
        Transform /* base */>(m, "FixedFunctionTransform", DOC(FixedFunctionTransform));

    py::class_<
        GradingPrimaryTransform,
        GradingPrimaryTransformRcPtr /* holder */,
        Transform /* base */>(m, "GradingPrimaryTransform", DOC(GradingPrimaryTransform));

    py::class_<
        GradingRGBCurveTransform,
        GradingRGBCurveTransformRcPtr /* holder */,
        Transform /* base */>(m, "GradingRGBCurveTransform", DOC(GradingRGBCurveTransform));

    py::class_<
        GradingHueCurveTransform,
        GradingHueCurveTransformRcPtr /* holder */,
        Transform /* base */>(m, "GradingHueCurveTransform", DOC(GradingHueCurveTransform));

    py::class_<GradingToneTransform, GradingToneTransformRcPtr /* holder */, Transform /* base */>(
        m,
    ...
    py::class_<MixingSlider>(m, "MixingSlider", DOC(MixingSlider));
    ...
    py::class_<ConfigMerger, ConfigMergerRcPtr /* holder */>(m, "ConfigMerger", DOC(ConfigMerger));

    // Enums
    py::enum_<LoggingLevel>(m, "LoggingLevel", py::arithmetic(), DOC(PyOpenColorIO, LoggingLevel))
    ...
    py::enum_<ReferenceSpaceType>(m, "ReferenceSpaceType", DOC(PyOpenColorIO, ReferenceSpaceType))
    ...
    py::enum_<ViewType>(m, "ViewType", DOC(PyOpenColorIO, ViewType))

        .value("VIEW_SHARED", VIEW_SHARED, DOC(PyOpenColorIO, ViewType, VIEW_SHARED))
        .value(
    ...
    py::enum_<TransformDirection>(m, "TransformDirection", DOC(PyOpenColorIO, TransformDirection))
    ...
    py::enum_<TransformType>(m, "TransformType", DOC(PyOpenColorIO, TransformType))
    ...
    py::enum_<Interpolation>(m, "Interpolation", DOC(PyOpenColorIO, Interpolation))

        .value("INTERP_UNKNOWN", INTERP_UNKNOWN, DOC(PyOpenColorIO, Interpolation, INTERP_UNKNOWN))
        .value("INTERP_NEAREST", INTERP_NEAREST, DOC(PyOpenColorIO, Interpolation, INTERP_NEAREST))
        .value("INTERP_LINEAR", INTERP_LINEAR, DOC(PyOpenColorIO, Interpolation, INTERP_LINEAR))
        .value(
            "INTERP_TETRAHEDRAL",
            INTERP_TETRAHEDRAL,
            DOC(PyOpenColorIO, Interpolation, INTERP_TETRAHEDRAL))
        .value("INTERP_CUBIC", INTERP_CUBIC, DOC(PyOpenColorIO, Interpolation, INTERP_CUBIC))
        .value("INTERP_DEFAULT", INTERP_DEFAULT, DOC(PyOpenColorIO, Interpolation, INTERP_DEFAULT))
        .value("INTERP_BEST", INTERP_BEST, DOC(PyOpenColorIO, Interpolation, INTERP_BEST))
        .export_values();

    py::enum_<BitDepth>(m, "BitDepth", py::arithmetic(), DOC(PyOpenColorIO, BitDepth))

        .value(
            "BIT_DEPTH_UNKNOWN",
            BIT_DEPTH_UNKNOWN,
            DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_UNKNOWN))
        .value("BIT_DEPTH_UINT8", BIT_DEPTH_UINT8, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_UINT8))
        .value("BIT_DEPTH_UINT10", BIT_DEPTH_UINT10, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_UINT10))
        .value("BIT_DEPTH_UINT12", BIT_DEPTH_UINT12, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_UINT12))
        .value("BIT_DEPTH_UINT14", BIT_DEPTH_UINT14, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_UINT14))
        .value("BIT_DEPTH_UINT16", BIT_DEPTH_UINT16, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_UINT16))
        .value("BIT_DEPTH_UINT32", BIT_DEPTH_UINT32, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_UINT32))
        .value("BIT_DEPTH_F16", BIT_DEPTH_F16, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_F16))
        .value("BIT_DEPTH_F32", BIT_DEPTH_F32, DOC(PyOpenColorIO, BitDepth, BIT_DEPTH_F32))
        .export_values();

    py::enum_<Lut1DHueAdjust>(m, "Lut1DHueAdjust", DOC(PyOpenColorIO, Lut1DHueAdjust))

        .value("HUE_NONE", HUE_NONE, DOC(PyOpenColorIO, Lut1DHueAdjust, HUE_NONE))
        .value("HUE_DW3", HUE_DW3, DOC(PyOpenColorIO, Lut1DHueAdjust, HUE_DW3))
        .value("HUE_WYPN", HUE_WYPN, DOC(PyOpenColorIO, Lut1DHueAdjust, HUE_WYPN))
        .export_values();

    py::enum_<ChannelOrdering>(m, "ChannelOrdering", DOC(PyOpenColorIO, ChannelOrdering))
    ...
    py::enum_<Allocation>(m, "Allocation", DOC(PyOpenColorIO, Allocation))
        ...
        .value("ALLOCATION_LG2", ALLOCATION_LG2, DOC(PyOpenColorIO, Allocation, ALLOCATION_LG2))
        .export_values();

    py::enum_<GpuLanguage>(m, "GpuLanguage", DOC(PyOpenColorIO, GpuLanguage))

        .value("GPU_LANGUAGE_CG", GPU_LANGUAGE_CG, DOC(PyOpenColorIO, GpuLanguage, GPU_LANGUAGE_CG))
        .value(
        ...
        .value(
            ...
            GPU_LANGUAGE_GLSL_VK_4_6,
            DOC(PyOpenColorIO, GpuLanguage, GPU_LANGUAGE_GLSL_VK_4_6))
        .value(
        ...
        .value("LANGUAGE_OSL_1", LANGUAGE_OSL_1, DOC(PyOpenColorIO, GpuLanguage, LANGUAGE_OSL_1))
        .export_values();

    py::enum_<EnvironmentMode>(m, "EnvironmentMode", DOC(PyOpenColorIO, EnvironmentMode))
    ...
    py::enum_<RangeStyle>(m, "RangeStyle", DOC(PyOpenColorIO, RangeStyle))

        .value("RANGE_NO_CLAMP", RANGE_NO_CLAMP, DOC(PyOpenColorIO, RangeStyle, RANGE_NO_CLAMP))
        .value("RANGE_CLAMP", RANGE_CLAMP, DOC(PyOpenColorIO, RangeStyle, RANGE_CLAMP))
        .export_values();

    py::enum_<FixedFunctionStyle>(m, "FixedFunctionStyle", DOC(PyOpenColorIO, FixedFunctionStyle))
    ...
    py::enum_<CDLStyle>(m, "CDLStyle", DOC(PyOpenColorIO, LoggingLevel))

        .value("CDL_ASC", CDL_ASC, DOC(PyOpenColorIO, CDLStyle, CDL_ASC))
        .value("CDL_NO_CLAMP", CDL_NO_CLAMP, DOC(PyOpenColorIO, CDLStyle, CDL_NO_CLAMP))
        .value(
    ...
    py::enum_<NegativeStyle>(m, "NegativeStyle", DOC(PyOpenColorIO, NegativeStyle))

        .value("NEGATIVE_CLAMP", NEGATIVE_CLAMP, DOC(PyOpenColorIO, NegativeStyle, NEGATIVE_CLAMP))
        .value(
            "NEGATIVE_MIRROR",
            NEGATIVE_MIRROR,
    ...
    py::enum_<GradingStyle>(m, "GradingStyle", DOC(PyOpenColorIO, GradingStyle))

        .value("GRADING_LOG", GRADING_LOG, DOC(PyOpenColorIO, GradingStyle, GRADING_LOG))
        .value("GRADING_LIN", GRADING_LIN, DOC(PyOpenColorIO, GradingStyle, GRADING_LIN))
        .value("GRADING_VIDEO", GRADING_VIDEO, DOC(PyOpenColorIO, GradingStyle, GRADING_VIDEO))
        .export_values();
    ...
    py::enum_<RGBCurveType>(m, "RGBCurveType", DOC(PyOpenColorIO, RGBCurveType))

        .value("RGB_RED", RGB_RED, DOC(PyOpenColorIO, RGBCurveType, RGB_RED))
        .value("RGB_GREEN", RGB_GREEN, DOC(PyOpenColorIO, RGBCurveType, RGB_GREEN))
        .value("RGB_BLUE", RGB_BLUE, DOC(PyOpenColorIO, RGBCurveType, RGB_BLUE))
        .value("RGB_MASTER", RGB_MASTER, DOC(PyOpenColorIO, RGBCurveType, RGB_MASTER))
        .value("RGB_NUM_CURVES", RGB_NUM_CURVES, DOC(PyOpenColorIO, RGBCurveType, RGB_NUM_CURVES))
        .export_values();

    py::enum_<HueCurveType>(m, "HueCurveType", DOC(PyOpenColorIO, HueCurveType))

        .value("HUE_HUE", HUE_HUE, DOC(PyOpenColorIO, HueCurveType, HUE_HUE))
        .value("HUE_SAT", HUE_SAT, DOC(PyOpenColorIO, HueCurveType, HUE_SAT))
        .value("HUE_LUM", HUE_LUM, DOC(PyOpenColorIO, HueCurveType, HUE_LUM))
        .value("LUM_SAT", LUM_SAT, DOC(PyOpenColorIO, HueCurveType, LUM_SAT))
        .value("SAT_SAT", SAT_SAT, DOC(PyOpenColorIO, HueCurveType, SAT_SAT))
        .value("LUM_LUM", LUM_LUM, DOC(PyOpenColorIO, HueCurveType, LUM_LUM))
        .value("SAT_LUM", SAT_LUM, DOC(PyOpenColorIO, HueCurveType, SAT_LUM))
        .value("HUE_FX", HUE_FX, DOC(PyOpenColorIO, HueCurveType, HUE_FX))
        .export_values();

    py::enum_<HSYTransformStyle>(m, "HSYTransformStyle", DOC(PyOpenColorIO, HSYTransformStyle))
    ...
    py::enum_<BSplineType>(m, "BSplineType", DOC(PyOpenColorIO, BSplineType))

        .value("B_SPLINE", B_SPLINE, DOC(PyOpenColorIO, BSplineType, B_SPLINE))
        .value(
            "DIAGONAL_B_SPLINE",
            DIAGONAL_B_SPLINE,
        ...
        .value(
            "HORIZONTAL1_B_SPLINE",
            HORIZONTAL1_B_SPLINE,
            DOC(PyOpenColorIO, BSplineType, HORIZONTAL1_B_SPLINE))
        .export_values();

    py::enum_<UniformDataType>(m, "UniformDataType", DOC(PyOpenColorIO, UniformDataType))

        .value(
            "UNIFORM_DOUBLE",
            UNIFORM_DOUBLE,
            DOC(PyOpenColorIO, UniformDataType, UNIFORM_DOUBLE))
        .value("UNIFORM_BOOL", UNIFORM_BOOL, DOC(PyOpenColorIO, UniformDataType, UNIFORM_BOOL))
        .value(
            "UNIFORM_FLOAT3",
            UNIFORM_FLOAT3,
    ...
    // Conversion
    m.def("BoolToString", &BoolToString, "value"_a, DOC(PyOpenColorIO, BoolToString));
    m.def("BoolFromString", &BoolFromString, "str"_a, DOC(PyOpenColorIO, BoolFromString));
    ...
    m.def("BitDepthIsFloat", &BitDepthIsFloat, "bitDepth"_a, DOC(PyOpenColorIO, BitDepthIsFloat));
    m.def("BitDepthToInt", &BitDepthToInt, "bitDepth"_a, DOC(PyOpenColorIO, BitDepthToInt));
    ...
    m.def("CDLStyleToString", &CDLStyleToString, "style"_a, DOC(PyOpenColorIO, CDLStyleToString));
    m.def(
        "CDLStyleFromString",
        &CDLStyleFromString,
        "str"_a,
