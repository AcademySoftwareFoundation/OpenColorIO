...
using ColorSpaceNameIterator
    = PyIterator<ConfigRcPtr, IT_COLOR_SPACE_NAME, SearchReferenceSpaceType, ColorSpaceVisibility>;
using ColorSpaceIterator
    = PyIterator<ConfigRcPtr, IT_COLOR_SPACE, SearchReferenceSpaceType, ColorSpaceVisibility>;
...
using VirtualViewIterator          = PyIterator<ConfigRcPtr, IT_VIRTUAL_DISPLAY_VIEW, ViewType>;
using ViewIterator                 = PyIterator<ConfigRcPtr, IT_DISPLAY_VIEW, std::string>;
using ViewForColorSpaceIterator
    = PyIterator<ConfigRcPtr, IT_DISPLAY_VIEW_COLORSPACE, std::string, std::string>;
using ViewForViewTypeIterator
    = PyIterator<ConfigRcPtr, IT_DISPLAY_VIEW_TYPE, ViewType, std::string>;
...
using NamedTransformNameIterator
    = PyIterator<ConfigRcPtr, IT_NAMED_TRANSFORM_NAME, NamedTransformVisibility>;
using NamedTransformIterator
    = PyIterator<ConfigRcPtr, IT_NAMED_TRANSFORM, NamedTransformVisibility>;
...
{
    auto clsConfig = py::class_<Config, ConfigRcPtr>(m.attr("Config"));

    auto clsEnvironmentVarNameIterator
        = py::class_<EnvironmentVarNameIterator>(clsConfig, "EnvironmentVarNameIterator");

    auto clsSearchPathIterator = py::class_<SearchPathIterator>(clsConfig, "SearchPathIterator");

    auto clsColorSpaceNameIterator
        = py::class_<ColorSpaceNameIterator>(clsConfig, "ColorSpaceNameIterator");

    auto clsColorSpaceIterator = py::class_<ColorSpaceIterator>(clsConfig, "ColorSpaceIterator");

    auto clsActiveColorSpaceNameIterator
        = py::class_<ActiveColorSpaceNameIterator>(clsConfig, "ActiveColorSpaceNameIterator");

    auto clsActiveColorSpaceIterator
        = py::class_<ActiveColorSpaceIterator>(clsConfig, "ActiveColorSpaceIterator");

    auto clsRoleNameIterator = py::class_<RoleNameIterator>(clsConfig, "RoleNameIterator");

    auto clsRoleColorSpaceIterator
        = py::class_<RoleColorSpaceIterator>(clsConfig, "RoleColorSpaceIterator");

    auto clsDisplayIterator = py::class_<DisplayIterator>(clsConfig, "DisplayIterator");

    auto clsDisplayAllIterator = py::class_<DisplayAllIterator>(clsConfig, "DisplayAllIterator");

    auto clsSharedViewIterator = py::class_<SharedViewIterator>(clsConfig, "SharedViewIterator");

    auto clsVirtualViewIterator = py::class_<VirtualViewIterator>(clsConfig, "VirtualViewIterator");

    auto clsViewIterator = py::class_<ViewIterator>(clsConfig, "ViewIterator");

    auto clsViewForColorSpaceIterator
        = py::class_<ViewForColorSpaceIterator>(clsConfig, "ViewForColorSpaceIterator");

    auto clsViewForViewTypeIterator
        = py::class_<ViewForViewTypeIterator>(clsConfig, "ViewForViewTypeIterator");

    auto clsActiveDisplaysListIterator
        = py::class_<ActiveDisplaysListIterator>(clsConfig, "ActiveDisplaysListIterator");

    auto clsActiveViewsListIterator
        = py::class_<ActiveViewsListIterator>(clsConfig, "ActiveViewsListIterator");

    auto clsLookNameIterator = py::class_<LookNameIterator>(clsConfig, "LookNameIterator");

    auto clsLookIterator = py::class_<LookIterator>(clsConfig, "LookIterator");

    auto clsViewTransformNameIterator
        = py::class_<ViewTransformNameIterator>(clsConfig, "ViewTransformNameIterator");

    auto clsViewTransformIterator
        = py::class_<ViewTransformIterator>(clsConfig, "ViewTransformIterator");

    auto clsNamedTransformNameIterator
        = py::class_<NamedTransformNameIterator>(clsConfig, "NamedTransformNameIterator");

    auto clsNamedTransformIterator
        = py::class_<NamedTransformIterator>(clsConfig, "NamedTransformIterator");

    auto clsActiveNamedTransformNameIterator = py::class_<ActiveNamedTransformNameIterator>(
        clsConfig,
        "ActiveNamedTransformNameIterator");

    auto clsActiveNamedTransformIterator
        = py::class_<ActiveNamedTransformIterator>(clsConfig, "ActiveNamedTransformIterator");

    clsConfig
        .def(py::init(&Config::Create), DOC(Config, Create))

        .def(
            "__deepcopy__",
            [](const ConstConfigRcPtr & self, py::dict) { return self->createEditableCopy(); },
            "memo"_a)

        .def_static("CreateRaw", &Config::CreateRaw, DOC(Config, CreateRaw))
        .def_static("CreateFromEnv", &Config::CreateFromEnv, DOC(Config, CreateFromEnv))
        .def_static(
            "CreateFromFile",
            &Config::CreateFromFile,
            "fileName"_a,
        ...
        .def_static(
            "CreateFromBuiltinConfig",
            &Config::CreateFromBuiltinConfig,
            DOC(Config, CreateFromBuiltinConfig))
        .def_static(
            "CreateFromConfigIOProxy",
            &Config::CreateFromConfigIOProxy,
            DOC(Config, CreateFromConfigIOProxy))
        .def("getMajorVersion", &Config::getMajorVersion, DOC(Config, getMajorVersion))
        .def("setMajorVersion", &Config::setMajorVersion, "major"_a, DOC(Config, setMajorVersion))
        .def("getMinorVersion", &Config::getMinorVersion, DOC(Config, getMinorVersion))
        .def("setMinorVersion", &Config::setMinorVersion, "minor"_a, DOC(Config, setMinorVersion))
        .def("setVersion", &Config::setVersion, "major"_a, "minor"_a, DOC(Config, setVersion))
        .def(
            "upgradeToLatestVersion",
            &Config::upgradeToLatestVersion,
            DOC(Config, upgradeToLatestVersion))
        .def("validate", &Config::validate, DOC(Config, validate))
        .def("getName", &Config::getName, DOC(Config, getName))
        .def("setName", &Config::setName, "name"_a.none(false), DOC(Config, setName))
        .def("getFamilySeparator", &Config::getFamilySeparator, DOC(Config, getFamilySeparator))
        .def(
            "setFamilySeparator",
            &Config::setFamilySeparator,
            "separator"_a,
            DOC(Config, setFamilySeparator))
        .def("getDescription", &Config::getDescription, DOC(Config, getDescription))
        .def(
            "setDescription",
        ...
        .def(
            "serialize",
            [](ConfigRcPtr & self, const std::string & fileName) {
        ...
        .def(
            "getCacheID",
            (const char * (Config::*)() const) & Config::getCacheID,
        ...
        // Resources
        .def("getCurrentContext", &Config::getCurrentContext, DOC(Config, getCurrentContext))
        .def(
            "addEnvironmentVar",
            &Config::addEnvironmentVar,
            "name"_a,
            "defaultValue"_a,
            DOC(Config, addEnvironmentVar))
        .def(
            "getEnvironmentVarNames",
            [](ConfigRcPtr & self) { return EnvironmentVarNameIterator(self); })
        .def(
            "getEnvironmentVarDefault",
            &Config::getEnvironmentVarDefault,
            "name"_a,
        ...
        .def("getEnvironmentMode", &Config::getEnvironmentMode, DOC(Config, getEnvironmentMode))
        .def("loadEnvironment", &Config::loadEnvironment, DOC(Config, loadEnvironment))
        .def(
            "getSearchPath",
            (const char * (Config::*)() const) & Config::getSearchPath,
            DOC(Config, getSearchPath))
        .def("setSearchPath", &Config::setSearchPath, "path"_a, DOC(Config, setSearchPath))
        .def("getSearchPaths", [](ConfigRcPtr & self) { return SearchPathIterator(self); })
        .def("clearSearchPaths", &Config::clearSearchPaths, DOC(Config, clearSearchPaths))
        .def("addSearchPath", &Config::addSearchPath, "path"_a, DOC(Config, addSearchPath))
        .def("getWorkingDir", &Config::getWorkingDir, DOC(Config, getWorkingDir))
        .def("setWorkingDir", &Config::setWorkingDir, "dirName"_a, DOC(Config, setWorkingDir))
        .def("getConfigIOProxy", &Config::getConfigIOProxy, DOC(Config, getConfigIOProxy))
        .def("setConfigIOProxy", &Config::setConfigIOProxy, "ciop"_a, DOC(Config, setConfigIOProxy))

        // ColorSpaces
        .def("getColorSpaces", &Config::getColorSpaces, "category"_a, DOC(Config, getColorSpaces))
        .def("getColorSpace", &Config::getColorSpace, "name"_a, DOC(Config, getColorSpace))
        .def(
            "getColorSpaceNames",
            [](ConfigRcPtr & self,
        ...
        .def(
            "getColorSpaceNames",
            [](ConfigRcPtr & self) { return ActiveColorSpaceNameIterator(self); })
        .def("getColorSpaces", [](ConfigRcPtr & self) { return ActiveColorSpaceIterator(self); })
        .def("getCanonicalName", &Config::getCanonicalName, "name"_a, DOC(Config, getCanonicalName))
        .def("addColorSpace", &Config::addColorSpace, "colorSpace"_a, DOC(Config, addColorSpace))
        .def("removeColorSpace", &Config::removeColorSpace, "name"_a, DOC(Config, removeColorSpace))
        .def(
            "isColorSpaceLinear",
            &Config::isColorSpaceLinear,
            "colorSpace"_a,
            "referenceSpaceType"_a,
            DOC(Config, isColorSpaceLinear))
        .def("isColorSpaceUsed", &Config::isColorSpaceUsed, "name"_a, DOC(Config, isColorSpaceUsed))
        .def("clearColorSpaces", &Config::clearColorSpaces, DOC(Config, clearColorSpaces))
        .def(
        ...
        .def_static(
            ...
            [](const ConstConfigRcPtr & srcConfig,
               ...
               const char * builtinColorSpaceName) {
                return Config::IdentifyBuiltinColorSpace(
                    srcConfig,
                    builtinConfig,
            ...
            [](const ConstConfigRcPtr & srcConfig,
               ...
               const char * builtinColorSpaceName) {
                ...
                return std::make_tuple(
                    std::string(srcInterchangePtr),
                    std::string(builtinInterchangePtr));
            },
            "srcConfig"_a,
            "srcColorSpaceName"_a,
            "builtinConfig"_a,
            "builtinColorSpaceName"_a,
            DOC(Config, IdentifyInterchangeSpace))

        // Roles
        .def("setRole", &Config::setRole, "role"_a, "colorSpaceName"_a, DOC(Config, setRole))
        .def("hasRole", &Config::hasRole, "role"_a, DOC(Config, hasRole))
        ...
        .def(
            ...
            "view"_a,
            "viewTransformName"_a,
            "colorSpaceName"_a,
            "looks"_a       = "",
            "ruleName"_a    = "",
            "description"_a = "",
            DOC(Config, addSharedView))
        .def("removeSharedView", &Config::removeSharedView, "view"_a, DOC(Config, removeSharedView))
        .def("clearSharedViews", &Config::clearSharedViews, DOC(Config, clearSharedViews))
        .def("getSharedViews", [](ConfigRcPtr & self) { return SharedViewIterator(self); })
        .def("getDefaultDisplay", &Config::getDefaultDisplay, DOC(Config, getDefaultDisplay))
        .def("getDisplays", [](ConfigRcPtr & self) { return DisplayIterator(self); })
        .def("getDisplaysAll", [](ConfigRcPtr & self) { return DisplayAllIterator(self); })
        .def(
            "getDefaultView",
            (const char * (Config::*)(const char *) const) & Config::getDefaultView,
            "display"_a,
            DOC(Config, getDefaultView))
        .def(
            "getDefaultView",
            (const char * (Config::*)(const char *, const char *) const) & Config::getDefaultView,
            "display"_a,
            "colorSpacename"_a,
            DOC(Config, getDefaultView))
        .def(
            "getViews",
            [](ConfigRcPtr & self, const std::string & display) {
                return ViewIterator(self, display);
            },
            "display"_a)
        .def(
            "getViews",
            [](ConfigRcPtr & self, ViewType type, const std::string & display) {
        ...
        .def(
            ...
            &Config::getDisplayViewTransformName,
            "display"_a,
            "view"_a,
            DOC(Config, getDisplayViewTransformName))
        .def(
            "getDisplayViewColorSpaceName",
            &Config::getDisplayViewColorSpaceName,
            "display"_a,
            "view"_a,
        ...
        .def(
            "removeDisplayView",
            &Config::removeDisplayView,
            "display"_a,
            "view"_a,
            DOC(Config, removeDisplayView))
        .def("clearDisplays", &Config::clearDisplays, DOC(Config, clearDisplays))
        .def_static(
            "AreViewsEqual",
        ...
        // Virtual Display
        .def("hasVirtualView", &Config::hasVirtualView, "view"_a, DOC(Config, hasVirtualView))
        .def(
        ...
        .def(
            "setDisplayTemporary",
            [](ConfigRcPtr & self, const std::string & display, bool isTemporary) {
                for (int i = 0; i < self->getNumDisplaysAll(); i++)
                {
                    std::string other(self->getDisplayAll(i));
                    if (StringUtils::Compare(display, other))
        ...
        .def(
            "getActiveDisplays",
            [](ConfigRcPtr & self) { return ActiveDisplaysListIterator(self); })
        .def(
            "addActiveDisplay",
            &Config::addActiveDisplay,
            "display"_a,
            DOC(Config, addActiveDisplay))
        .def(
            "removeActiveDisplay",
            &Config::removeActiveDisplay,
            "display"_a,
            DOC(Config, removeActiveDisplay))
        .def("clearActiveDisplays", &Config::clearActiveDisplays, DOC(Config, clearActiveDisplays))
        .def(
            "getNumActiveDisplays",
            &Config::getNumActiveDisplays,
            DOC(Config, getNumActiveDisplays))

        .def("setActiveViews", &Config::setActiveViews, "views"_a, DOC(Config, setActiveViews))
        .def("getActiveViews", [](ConfigRcPtr & self) { return ActiveViewsListIterator(self); })
        .def("addActiveView", &Config::addActiveView, "view"_a, DOC(Config, addActiveView))
        .def("removeActiveView", &Config::removeActiveView, "view"_a, DOC(Config, removeActiveView))
        .def("clearActiveViews", &Config::clearActiveViews, DOC(Config, clearActiveViews))
        .def("getNumActiveViews", &Config::getNumActiveViews, DOC(Config, getNumActiveViews))
        ...
        .def(
            "setDefaultLumaCoefs",
            [](ConfigRcPtr & self, const std::array<double, 3> & rgb) {
        ...
        // Look
        .def("getLook", &Config::getLook, "name"_a, DOC(Config, getLook))
        .def("getLookNames", [](ConfigRcPtr & self) { return LookNameIterator(self); })
        .def("getLooks", [](ConfigRcPtr & self) { return LookIterator(self); })
        .def("addLook", &Config::addLook, "look"_a, DOC(Config, addLook))
        .def("clearLooks", &Config::clearLooks, DOC(Config, clearLooks))

        // View Transforms
        .def("getViewTransform", &Config::getViewTransform, "name"_a, DOC(Config, getViewTransform))
        .def(
            "getViewTransformNames",
            [](ConfigRcPtr & self) { return ViewTransformNameIterator(self); })
        .def("getViewTransforms", [](ConfigRcPtr & self) { return ViewTransformIterator(self); })
        .def(
            "addViewTransform",
            &Config::addViewTransform,
            "viewTransform"_a,
        ...
        .def("clearViewTransforms", &Config::clearViewTransforms, DOC(Config, clearViewTransforms))
        ...
        .def(
            ...
            [](ConfigRcPtr & self, NamedTransformVisibility visibility) {
        ...
        .def(
            "getNamedTransformNames",
            [](ConfigRcPtr & self) { return ActiveNamedTransformNameIterator(self); })
        .def(
            "getNamedTransforms",
            [](ConfigRcPtr & self) { return ActiveNamedTransformIterator(self); })
        .def("addNamedTransform", &Config::addNamedTransform, "namedTransform"_a)
        .def("clearNamedTransforms", &Config::clearNamedTransforms)

        // Viewing Rules
        .def("getViewingRules", &Config::getViewingRules, DOC(Config, getViewingRules))
        .def(
            "setViewingRules",
            &Config::setViewingRules,
            "ViewingRules"_a,
            DOC(Config, setViewingRules))

        // File Rules
        .def("getFileRules", &Config::getFileRules, DOC(Config, getFileRules))
        .def("setFileRules", &Config::setFileRules, "fileRules"_a, DOC(Config, setFileRules))
        .def(
        ...
        .def(
            ...
            &Config::filepathOnlyMatchesDefaultRule,
            "filePath"_a,
        ...
        .def(
            "getProcessor",
            (ConstProcessorRcPtr (
                Config::*)(const ConstColorSpaceRcPtr &, const ConstColorSpaceRcPtr &) const)
                & Config::getProcessor,
            "srcColorSpace"_a,
            "dstColorSpace"_a,
        ...
        .def(
            ...
            (ConstProcessorRcPtr (Config::*)(const char *, const char *) const)
                & Config::getProcessor,
            "srcColorSpaceName"_a,
            "dstColorSpaceName"_a,
            DOC(Config, getProcessor, 3))
        .def(
            "getProcessor",
            (ConstProcessorRcPtr (Config::*)(const ConstContextRcPtr &, const char *, const char *)
                 const)
                & Config::getProcessor,
            "context"_a,
            "srcColorSpaceName"_a,
        ...
        .def(
            "getProcessor",
            (ConstProcessorRcPtr (
                Config::*)(const char *, const char *, const char *, TransformDirection) const)
                & Config::getProcessor,
            "srcColorSpaceName"_a,
            "display"_a,
            "view"_a,
        ...
        .def(
            "getProcessor",
            (ConstProcessorRcPtr (Config::*)(const ConstNamedTransformRcPtr &, TransformDirection)
                 const)
                & Config::getProcessor,
            "namedTransform"_a,
            "direction"_a,
        ...
        .def(
            "getProcessor",
            (ConstProcessorRcPtr (Config::*)(const char *, TransformDirection) const)
                & Config::getProcessor,
            "namedTransformName"_a,
            "direction"_a,
            DOC(Config, getProcessor, 9))
        .def(
            "getProcessor",
            (ConstProcessorRcPtr (
                Config::*)(const ConstContextRcPtr &, const char *, TransformDirection) const)
                & Config::getProcessor,
            "context"_a,
            "namedTransformName"_a,
            "direction"_a,
        ...
        .def(
            "getProcessor",
            (ConstProcessorRcPtr (Config::*)(const ConstTransformRcPtr &, TransformDirection) const)
                & Config::getProcessor,
            "transform"_a,
            "direction"_a,
        ...
        .def_static(
            ...
            [](const ConstConfigRcPtr & srcConfig,
               const char * srcColorSpaceName,
               const char * builtinColorSpaceName) {
                return Config::GetProcessorToBuiltinColorSpace(
                    srcConfig,
                    srcColorSpaceName,
                    builtinColorSpaceName);
            },
        ...
        .def_static(
            ...
            [](const char * builtinColorSpaceName,
               ...
               const char * srcColorSpaceName) {
                return Config::GetProcessorFromBuiltinColorSpace(
                    builtinColorSpaceName,
                    srcConfig,
                    srcColorSpaceName);
            },
        ...
        .def_static(
            ...
            [](const ConstConfigRcPtr & srcConfig,
               ...
               const char * dstColorSpaceName) {
                return Config::GetProcessorFromConfigs(
                    srcConfig,
                    srcColorSpaceName,
                    dstConfig,
                    dstColorSpaceName);
        ...
        .def_static(
            ...
            "srcConfig"_a,
            "srcColorSpaceName"_a,
            "srcInterchangeName"_a,
            "dstConfig"_a,
            "dstColorSpaceName"_a,
            "dstInterchangeName"_a,
        ...
        .def(
            "archive",
            [](ConfigRcPtr & self, const char * filepath) {
    ...
    clsEnvironmentVarNameIterator
        .def(
            "__len__",
            [](EnvironmentVarNameIterator & it) { return it.m_obj->getNumEnvironmentVars(); })
        .def(
            "__getitem__",
            [](EnvironmentVarNameIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumEnvironmentVars());
                return it.m_obj->getEnvironmentVarNameByIndex(i);
            })
        .def(
            "__iter__",
            [](EnvironmentVarNameIterator & it) -> EnvironmentVarNameIterator & { return it; })
    ...
    clsColorSpaceNameIterator
        .def(
            "__len__",
            [](ColorSpaceNameIterator & it) {
                return it.m_obj->getNumColorSpaces(std::get<0>(it.m_args), std::get<1>(it.m_args));
            })
        .def(
            "__getitem__",
            [](ColorSpaceNameIterator & it, int i) {
                it.checkIndex(
                    i,
                    it.m_obj->getNumColorSpaces(std::get<0>(it.m_args), std::get<1>(it.m_args)));
                return it.m_obj->getColorSpaceNameByIndex(
                    std::get<0>(it.m_args),
                    std::get<1>(it.m_args),
                    i);
            })
        .def("__iter__", [](ColorSpaceNameIterator & it) -> ColorSpaceNameIterator & { return it; })
    ...
    clsColorSpaceIterator
        .def(
            "__len__",
            [](ColorSpaceIterator & it) {
                return it.m_obj->getNumColorSpaces(std::get<0>(it.m_args), std::get<1>(it.m_args));
            })
        .def(
            "__getitem__",
            [](ColorSpaceIterator & it, int i) {
                it.checkIndex(
                    i,
                    it.m_obj->getNumColorSpaces(std::get<0>(it.m_args), std::get<1>(it.m_args)));
                const char * name = it.m_obj->getColorSpaceNameByIndex(
                    std::get<0>(it.m_args),
                    std::get<1>(it.m_args),
                    i);
    ...
    clsActiveColorSpaceNameIterator
        .def(
            "__len__",
            [](ActiveColorSpaceNameIterator & it) { return it.m_obj->getNumColorSpaces(); })
        .def(
            "__getitem__",
            [](ActiveColorSpaceNameIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumColorSpaces());
                return it.m_obj->getColorSpaceNameByIndex(i);
            })
        .def(
            "__iter__",
            [](ActiveColorSpaceNameIterator & it) -> ActiveColorSpaceNameIterator & { return it; })
    ...
    clsActiveColorSpaceIterator
        .def("__len__", [](ActiveColorSpaceIterator & it) { return it.m_obj->getNumColorSpaces(); })
        .def(
            "__getitem__",
            [](ActiveColorSpaceIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumColorSpaces());
        ...
        .def(
            "__iter__",
            [](ActiveColorSpaceIterator & it) -> ActiveColorSpaceIterator & { return it; })
    ...
    clsRoleColorSpaceIterator
        ...
        .def(
            "__getitem__",
            [](RoleColorSpaceIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumRoles());
                return py::make_tuple(it.m_obj->getRoleName(i), it.m_obj->getRoleColorSpace(i));
            })
        .def("__iter__", [](RoleColorSpaceIterator & it) -> RoleColorSpaceIterator & { return it; })
    ...
    clsSharedViewIterator
        .def(
            "__len__",
            [](SharedViewIterator & it) { return it.m_obj->getNumViews(VIEW_SHARED, nullptr); })
        .def(
            "__getitem__",
            [](SharedViewIterator & it, int i) {
    ...
    clsViewIterator
        .def(
            "__len__",
            [](ViewIterator & it) { return it.m_obj->getNumViews(std::get<0>(it.m_args).c_str()); })
        .def(
            "__getitem__",
            [](ViewIterator & it, int i) {
    ...
    clsViewForColorSpaceIterator
        .def(
            "__len__",
            [](ViewForColorSpaceIterator & it) {
                return it.m_obj->getNumViews(
                    std::get<0>(it.m_args).c_str(),
                    std::get<1>(it.m_args).c_str());
            })
        .def(
            "__getitem__",
            [](ViewForColorSpaceIterator & it, int i) {
                it.checkIndex(
                    i,
                    it.m_obj->getNumViews(
                        std::get<0>(it.m_args).c_str(),
                        std::get<1>(it.m_args).c_str()));
                return it.m_obj->getView(
                    std::get<0>(it.m_args).c_str(),
                    std::get<1>(it.m_args).c_str(),
                    i);
            })
        .def(
            "__iter__",
            [](ViewForColorSpaceIterator & it) -> ViewForColorSpaceIterator & { return it; })
        .def("__next__", [](ViewForColorSpaceIterator & it) {
            int i = it.nextIndex(it.m_obj->getNumViews(
                std::get<0>(it.m_args).c_str(),
                std::get<1>(it.m_args).c_str()));
            return it.m_obj->getView(
                std::get<0>(it.m_args).c_str(),
    ...
    clsViewForViewTypeIterator
        ...
        .def(
            "__getitem__",
            [](ViewForViewTypeIterator & it, int i) {
                it.checkIndex(
                    i,
                    it.m_obj->getNumViews(std::get<0>(it.m_args), std::get<1>(it.m_args).c_str()));
                return it.m_obj->getView(std::get<0>(it.m_args), std::get<1>(it.m_args).c_str(), i);
            })
        .def(
            "__iter__",
            [](ViewForViewTypeIterator & it) -> ViewForViewTypeIterator & { return it; })
    ...
    clsActiveDisplaysListIterator
        .def(
            "__len__",
            [](ActiveDisplaysListIterator & it) { return it.m_obj->getNumActiveDisplays(); })
        .def(
            "__getitem__",
            [](ActiveDisplaysListIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumActiveDisplays());
                return it.m_obj->getActiveDisplay(i);
            })
        .def(
            "__iter__",
            [](ActiveDisplaysListIterator & it) -> ActiveDisplaysListIterator & { return it; })
    ...
    clsActiveViewsListIterator
        ...
        .def(
            "__getitem__",
            [](ActiveViewsListIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumActiveViews());
                return it.m_obj->getActiveView(i);
            })
        .def(
            "__iter__",
            [](ActiveViewsListIterator & it) -> ActiveViewsListIterator & { return it; })
    ...
    clsViewTransformNameIterator
        .def(
            "__len__",
            [](ViewTransformNameIterator & it) { return it.m_obj->getNumViewTransforms(); })
        .def(
            "__getitem__",
            [](ViewTransformNameIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumViewTransforms());
                return it.m_obj->getViewTransformNameByIndex(i);
            })
        .def(
            "__iter__",
            [](ViewTransformNameIterator & it) -> ViewTransformNameIterator & { return it; })
    ...
    clsViewTransformIterator
        .def("__len__", [](ViewTransformIterator & it) { return it.m_obj->getNumViewTransforms(); })
        .def(
            "__getitem__",
            [](ViewTransformIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumViewTransforms());
    ...
    clsNamedTransformNameIterator
        .def(
            "__len__",
            [](NamedTransformNameIterator & it) {
                return it.m_obj->getNumNamedTransforms(std::get<0>(it.m_args));
            })
        .def(
            "__getitem__",
            [](NamedTransformNameIterator & it, int i) {
        ...
        .def(
            "__iter__",
            [](NamedTransformNameIterator & it) -> NamedTransformNameIterator & { return it; })
    ...
    clsNamedTransformIterator
        .def(
            "__len__",
            [](NamedTransformIterator & it) {
                return it.m_obj->getNumNamedTransforms(std::get<0>(it.m_args));
            })
        .def(
            "__getitem__",
            [](NamedTransformIterator & it, int i) {
                it.checkIndex(i, it.m_obj->getNumNamedTransforms(std::get<0>(it.m_args)));
                const char * name
                    = it.m_obj->getNamedTransformNameByIndex(std::get<0>(it.m_args), i);
                return it.m_obj->getNamedTransform(name);
            })
        .def("__iter__", [](NamedTransformIterator & it) -> NamedTransformIterator & { return it; })
    ...
    clsActiveNamedTransformNameIterator
        .def(
            "__len__",
            [](ActiveNamedTransformNameIterator & it) { return it.m_obj->getNumNamedTransforms(); })
        .def(
            "__getitem__",
            [](ActiveNamedTransformNameIterator & it, int i) {
                it.checkIndex(i, (int)it.m_obj->getNumNamedTransforms());
                return it.m_obj->getNamedTransformNameByIndex(i);
            })
        .def(
            "__iter__",
            [](ActiveNamedTransformNameIterator & it) -> ActiveNamedTransformNameIterator & {
                return it;
            })
    ...
    clsActiveNamedTransformIterator
        .def(
            "__len__",
            [](ActiveNamedTransformIterator & it) { return it.m_obj->getNumNamedTransforms(); })
        .def(
            "__getitem__",
            [](ActiveNamedTransformIterator & it, int i) {
                it.checkIndex(i, (int)it.m_obj->getNumNamedTransforms());
        ...
        .def(
            "__iter__",
            [](ActiveNamedTransformIterator & it) -> ActiveNamedTransformIterator & { return it; })
    ...
    m.def("GetCurrentConfig", &GetCurrentConfig, DOC(PyOpenColorIO, GetCurrentConfig));
    m.def("SetCurrentConfig", &SetCurrentConfig, "config"_a, DOC(PyOpenColorIO, SetCurrentConfig));

    m.def("ExtractOCIOZArchive", &ExtractOCIOZArchive, DOC(PyOpenColorIO, ExtractOCIOZArchive));

    m.def("ResolveConfigPath", &ResolveConfigPath, DOC(PyOpenColorIO, ResolveConfigPath));
}
