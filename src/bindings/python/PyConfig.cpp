...
namespace OCIO_NAMESPACE
{
    ...
    void bindPyConfig(py::module &m)
    {
        auto cls = py::class_<Config, ConfigRcPtr /* holder */>(m, "Config")
                       ...
                       .def_static(
                           "CreateFromStream", [](const std::string &str) {
                       ...
                       .def(
                           "serialize", [](ConfigRcPtr &self, const std::string &fileName) {
                       ...
                       .def("getCacheID", (const char *(Config::*)(const ConstContextRcPtr &) const) & Config::getCacheID, "context"_a)
                       ...
                       .def(
                           "getColorSpaceNames", [](ConfigRcPtr &self, SearchReferenceSpaceType searchReferenceType, ColorSpaceVisibility visibility) {
                               return ColorSpaceNameIterator(self, searchReferenceType, visibility);
                           },
                           "searchReferenceType"_a, "visibility"_a)
                       .def(
                           "getColorSpaces", [](ConfigRcPtr &self, SearchReferenceSpaceType searchReferenceType, ColorSpaceVisibility visibility) {
                       ...
                       .def("addSharedView", (void (Config::*)(const char *, const char *, const char *, const char *, const char *, const char *)) & Config::addSharedView, "view"_a, "viewTransformName"_a, "colorSpaceName"_a, "looks"_a = "", "ruleName"_a = "", "description"_a = "")
                       ...
                       .def(
                           "getViews", [](ConfigRcPtr &self, const std::string &display) {
                               return ViewIterator(self, display);
                           },
                           "display"_a)
                       .def(
                           "getViews", [](ConfigRcPtr &self, const std::string &display, const std::string &colorSpaceName) {
                               return ViewForColorSpaceIterator(self, display, colorSpaceName);
                           },
                           "display"_a, "colorSpaceName"_a)
                       .def("getDisplayViewTransformName", &Config::getDisplayViewTransformName, "display"_a, "view"_a)
                       ...
                       .def("addDisplayView", (void (Config::*)(const char *, const char *, const char *, const char *)) & Config::addDisplayView, "display"_a, "view"_a, "colorSpaceName"_a, "looks"_a = "")
                       .def("addDisplayView", (void (Config::*)(const char *, const char *, const char *, const char *, const char *, const char *, const char *)) & Config::addDisplayView, "display"_a, "view"_a, "viewTransform"_a, "displayColorSpaceName"_a, "looks"_a = "", "ruleName"_a = "", "description"_a = "")
                       ...
                       .def(
                           "setDefaultLumaCoefs", [](ConfigRcPtr &self, const std::array<double, 3> &rgb) {
                       ...
                       .def("getDefaultSceneToDisplayViewTransform", &Config::getDefaultSceneToDisplayViewTransform)
                       ...
                       .def("getColorSpaceFromFilepath", (const char *(Config::*)(const char *) const) & Config::getColorSpaceFromFilepath, "filePath"_a)
                       .def("getColorSpaceFromFilepath", (const char *(Config::*)(const char *, size_t &) const) & Config::getColorSpaceFromFilepath, "filePath"_a, "ruleIndex"_a)
                       .def("filepathOnlyMatchesDefaultRule", &Config::filepathOnlyMatchesDefaultRule, "filePath"_a)

                       // Processors
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const ConstColorSpaceRcPtr &, const ConstColorSpaceRcPtr &) const) & Config::getProcessor, "srcColorSpace"_a, "dstColorSpace"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const ConstContextRcPtr &, const ConstColorSpaceRcPtr &, const ConstColorSpaceRcPtr &) const) & Config::getProcessor, "context"_a, "srcColorSpace"_a, "dstColorSpace"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const char *, const char *) const) & Config::getProcessor, "srcColorSpaceName"_a, "dstColorSpaceName"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const ConstContextRcPtr &, const char *, const char *) const) & Config::getProcessor, "context"_a, "srcColorSpaceName"_a, "dstColorSpaceName"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const char *, const char *, const char *, TransformDirection) const) & Config::getProcessor, "srcColorSpaceName"_a, "display"_a, "view"_a, "direction"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const ConstContextRcPtr &, const char *, const char *, const char *, TransformDirection) const) & Config::getProcessor, "context"_a, "srcColorSpaceName"_a, "display"_a, "view"_a, "direction"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const ConstTransformRcPtr &) const) & Config::getProcessor, "transform"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const ConstTransformRcPtr &, TransformDirection) const) & Config::getProcessor, "transform"_a, "direction"_a)
                       .def("getProcessor", (ConstProcessorRcPtr(Config::*)(const ConstContextRcPtr &, const ConstTransformRcPtr &, TransformDirection) const) & Config::getProcessor, "context"_a, "transform"_a, "direction"_a)

                       .def_static(
                           "GetProcessorFromConfigs", [](const ConstConfigRcPtr &srcConfig, const char *srcColorSpaceName, const ConstConfigRcPtr &dstConfig, const char *dstColorSpaceName) {
                       ...
                       .def_static(
                           "GetProcessorFromConfigs", [](const ConstContextRcPtr &srcContext, const ConstConfigRcPtr &srcConfig, const char *srcColorSpaceName, const ConstContextRcPtr &dstContext, const ConstConfigRcPtr &dstConfig, const char *dstColorSpaceName) {
                               return Config::GetProcessorFromConfigs(srcContext, srcConfig, srcColorSpaceName,
                                                                      dstContext, dstConfig, dstColorSpaceName);
                           },
                           "srcContext"_a, "srcConfig"_a, "srcColorSpaceName"_a, "dstContext"_a, "dstConfig"_a, "dstColorSpaceName"_a)
                       .def_static(
                           "GetProcessorFromConfigs", [](const ConstConfigRcPtr &srcConfig, const char *srcColorSpaceName, const char *srcInterchangeName, const ConstConfigRcPtr &dstConfig, const char *dstColorSpaceName, const char *dstInterchangeName) {
                           ...
                           "srcConfig"_a, "srcColorSpaceName"_a, "srcInterchangeName"_a, "dstConfig"_a, "dstColorSpaceName"_a, "dstInterchangeName"_a)
                       .def_static(
                           "GetProcessorFromConfigs", [](const ConstContextRcPtr &srcContext, const ConstConfigRcPtr &srcConfig, const char *srcColorSpaceName, const char *srcInterchangeName, const ConstContextRcPtr &dstContext, const ConstConfigRcPtr &dstConfig, const char *dstColorSpaceName, const char *dstInterchangeName) {
                           ...
                           "srcContext"_a, "srcConfig"_a, "srcColorSpaceName"_a, "srcInterchangeName"_a, "dstContext"_a, "dstConfig"_a, "dstColorSpaceName"_a, "dstInterchangeName"_a)
        ...
        py::class_<ViewIterator>(cls, "ViewIterator")
            .def("__len__", [](ViewIterator &it) { return it.m_obj->getNumViews(std::get<0>(it.m_args).c_str()); })
        ...
        py::class_<ViewForColorSpaceIterator>(cls, "ViewForColorSpaceIterator")
            .def("__len__", [](ViewForColorSpaceIterator &it) { return it.m_obj->getNumViews(std::get<0>(it.m_args).c_str(),
