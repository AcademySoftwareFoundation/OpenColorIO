...
void bindPyColorSpaceSet(py::module & m)
{
    ...
    auto clsColorSpaceSet = py::class_<ColorSpaceSet, ColorSpaceSetRcPtr>(m.attr("ColorSpaceSet"));

    auto clsColorSpaceNameIterator
        = py::class_<ColorSpaceNameIterator>(clsColorSpaceSet, "ColorSpaceNameIterator");

    auto clsColorSpaceIterator
        = py::class_<ColorSpaceIterator>(clsColorSpaceSet, "ColorSpaceIterator");

    clsColorSpaceSet
        .def(py::init(&ColorSpaceSet::Create), DOC(ColorSpaceSet, Create))

        .def(
            "__deepcopy__",
            [](const ConstColorSpaceSetRcPtr & self, py::dict) {
        ...
        .def(
            "__sub__",
            [](ConstColorSpaceSetRcPtr & self, ConstColorSpaceSetRcPtr & rcss) {
                return self - rcss;
            },
            py::is_operator(),
        ...
        .def(
            "getColorSpaceNames",
            [](ColorSpaceSetRcPtr & self) { return ColorSpaceNameIterator(self); })
        .def("getColorSpaces", [](ColorSpaceSetRcPtr & self) { return ColorSpaceIterator(self); })
        .def(
            "getColorSpace",
            &ColorSpaceSet::getColorSpace,
            "name"_a,
            DOC(ColorSpaceSet, getColorSpace))
        .def(
            "hasColorSpace",
            &ColorSpaceSet::hasColorSpace,
            "name"_a,
            DOC(ColorSpaceSet, hasColorSpace))
        .def(
            "addColorSpace",
            &ColorSpaceSet::addColorSpace,
            "colorSpace"_a,
            DOC(ColorSpaceSet, addColorSpace))
        .def(
            "addColorSpaces",
            &ColorSpaceSet::addColorSpaces,
            "colorSpaces"_a,
            DOC(ColorSpaceSet, addColorSpaces))
        .def(
            "removeColorSpace",
            &ColorSpaceSet::removeColorSpace,
            "colorSpace"_a,
            DOC(ColorSpaceSet, removeColorSpace))
        .def(
            "removeColorSpaces",
            &ColorSpaceSet::removeColorSpaces,
            "colorSpaces"_a,
            DOC(ColorSpaceSet, removeColorSpaces))
        .def(
            "clearColorSpaces",
            &ColorSpaceSet::clearColorSpaces,
            DOC(ColorSpaceSet, clearColorSpaces));

    clsColorSpaceNameIterator
        .def("__len__", [](ColorSpaceNameIterator & it) { return it.m_obj->getNumColorSpaces(); })
        .def(
            "__getitem__",
