...
{
    m.def_submodule("DisplayViewHelpers")
                                ...
                                TransformDirection direction)
        {
            ...
            return DisplayViewHelpers::GetProcessor(config, usedContext, workingName, displayName,
                                                    viewName, channelView, direction);
        },
      ...
      .def("AddDisplayView", [](ConfigRcPtr & config,
                                ...
                                const std::string & connectionColorSpaceName)
        {
            ...
            DisplayViewHelpers::AddDisplayView(config, displayName.c_str(), viewName.c_str(),
                                               lookName.c_str(), colorSpaceName.c_str(),
                                               colorSpaceFamily.c_str(),
                                               colorSpaceDescription.c_str(), categories.c_str(),
