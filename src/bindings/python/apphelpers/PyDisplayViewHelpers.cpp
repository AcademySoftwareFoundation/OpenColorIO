    ...
    auto mDisplayViewHelpers
        = m.def_submodule("DisplayViewHelpers")
              .def(
                  ...
                  [](const ConstConfigRcPtr & config,
                     ...
                     TransformDirection direction) {
                      ...
                      return DisplayViewHelpers::GetProcessor(
                          config,
                          usedContext,
                          workingName,
                          displayName,
              ...
              .def(
                  ...
                  &DisplayViewHelpers::GetIdentityProcessor,
                  "config"_a.none(false),
              ...
              .def(
                  ...
                  [](ConfigRcPtr & config,
                     ...
                     const std::string & connectionColorSpaceName) {
                      DisplayViewHelpers::AddDisplayView(
                          config,
                          displayName.c_str(),
                          viewName.c_str(),
                          lookName.c_str(),
              ...
              .def(
                  "RemoveDisplayView",
                  &DisplayViewHelpers::RemoveDisplayView,
                  "config"_a.none(false),
                  "displayName"_a.none(false),
                  "viewName"_a.none(false),
