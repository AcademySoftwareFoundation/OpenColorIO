...
{
    auto clsMixingSlider = py::class_<MixingSlider>(m.attr("MixingSlider"));
    ...
    clsMixingSlider
        .def(
            "setSliderMinEdge",
            &MixingSlider::setSliderMinEdge,
            DOC(MixingSlider, setSliderMinEdge))
        .def(
            "getSliderMinEdge",
            &MixingSlider::getSliderMinEdge,
            DOC(MixingSlider, getSliderMinEdge))
        .def(
            "setSliderMaxEdge",
            &MixingSlider::setSliderMaxEdge,
            DOC(MixingSlider, setSliderMaxEdge))
        .def(
            "getSliderMaxEdge",
            &MixingSlider::getSliderMaxEdge,
            DOC(MixingSlider, getSliderMaxEdge))
        .def(
            "sliderToMixing",
            &MixingSlider::sliderToMixing,
            "sliderUnits"_a,
            DOC(MixingSlider, sliderToMixing))
        .def(
            "mixingToSlider",
            &MixingSlider::mixingToSlider,
            "mixingUnits"_a,
    ...
    clsMixingColorSpaceManager
        .def(
            py::init(
                [](ConstConfigRcPtr & config) { return MixingColorSpaceManager::Create(config); }),
            "config"_a.none(false),
            DOC(MixingColorSpaceManager, Create))
        .def(
            "getMixingSpaces",
            [](MixingColorSpaceManagerRcPtr & self) { return MixingSpaceIterator(self); })
        .def(
            "setSelectedMixingSpaceIdx",
            &MixingColorSpaceManager::setSelectedMixingSpaceIdx,
            DOC(MixingColorSpaceManager, setSelectedMixingSpaceIdx))
        .def(
            "setSelectedMixingSpace",
            &MixingColorSpaceManager::setSelectedMixingSpace,
            "mixingSpace"_a.none(false),
            DOC(MixingColorSpaceManager, setSelectedMixingSpace))
        .def(
            "getSelectedMixingSpaceIdx",
            &MixingColorSpaceManager::getSelectedMixingSpaceIdx,
            DOC(MixingColorSpaceManager, getSelectedMixingSpaceIdx))
        .def(
            "isPerceptuallyUniform",
            &MixingColorSpaceManager::isPerceptuallyUniform,
            DOC(MixingColorSpaceManager, isPerceptuallyUniform))
        .def(
            "getMixingEncodings",
            [](MixingColorSpaceManagerRcPtr & self) { return MixingEncodingIterator(self); })
        .def(
            "setSelectedMixingEncodingIdx",
            &MixingColorSpaceManager::setSelectedMixingEncodingIdx,
            DOC(MixingColorSpaceManager, setSelectedMixingEncodingIdx))
        .def(
            "setSelectedMixingEncoding",
            &MixingColorSpaceManager::setSelectedMixingEncoding,
            "mixingEncoding"_a.none(false),
            DOC(MixingColorSpaceManager, setSelectedMixingEncoding))
        .def(
            "getSelectedMixingEncodingIdx",
            &MixingColorSpaceManager::getSelectedMixingEncodingIdx,
            DOC(MixingColorSpaceManager, getSelectedMixingEncodingIdx))
        .def(
            "refresh",
            &MixingColorSpaceManager::refresh,
            "config"_a.none(false),
            DOC(MixingColorSpaceManager, refresh))
        .def(
            "getProcessor",
            &MixingColorSpaceManager::getProcessor,
        ...
        .def(
            "getSlider",
            (MixingSlider
             & (MixingColorSpaceManager::*)(float sliderMixingMinEdge, float sliderMixingMaxEdge))
                & MixingColorSpaceManager::getSlider,
            "sliderMixingMinEdge"_a.none(false),
            "sliderMixingMaxEdge"_a.none(false),
            py::return_value_policy::reference_internal,
            DOC(MixingColorSpaceManager, getSlider));
