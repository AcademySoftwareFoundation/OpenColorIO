...
void bindPyConfigMergingHelpers(py::module & m)
{
    ...
    auto clsConfigMergingParameters
        = py::class_<ConfigMergingParameters, ConfigMergingParametersRcPtr>(
            m.attr("ConfigMergingParameters"));

    auto enumMergeStrategies = py::enum_<ConfigMergingParameters::MergeStrategies>(
    ...
    clsConfigMergingParameters
        .def_static(
            "Create",
            &ConfigMergingParameters::Create,
            DOC(ConfigMergingParameters, Create))
        .def(
            "__deepcopy__",
            [](const ConstConfigMergingParametersRcPtr & self, py::dict) {
                return self->createEditableCopy();
            },
            "memo"_a)
        .def(
            "setBaseConfigName",
            &ConfigMergingParameters::setBaseConfigName,
            "baseConfig"_a,
            DOC(ConfigMergingParameters, setBaseConfigName))
        .def(
            "getBaseConfigName",
            &ConfigMergingParameters::getBaseConfigName,
            DOC(ConfigMergingParameters, getBaseConfigName))
        .def(
            "setInputConfigName",
            &ConfigMergingParameters::setInputConfigName,
            "inputConfig"_a,
            DOC(ConfigMergingParameters, setInputConfigName))
        .def(
            "getInputConfigName",
            &ConfigMergingParameters::getInputConfigName,
            DOC(ConfigMergingParameters, getInputConfigName))
        .def(
            "setOutputName",
            &ConfigMergingParameters::setOutputName,
            "outputName"_a,
            DOC(ConfigMergingParameters, setOutputName))
        .def(
            "getOutputName",
            &ConfigMergingParameters::getOutputName,
    ...
    auto clsConfigMerger = py::class_<ConfigMerger, ConfigMergerRcPtr>(m.attr("ConfigMerger"));

    clsConfigMerger.def_static("Create", &ConfigMerger::Create, DOC(ConfigMerger, Create))
        .def_static(
            "CreateFromFile",
            &ConfigMerger::CreateFromFile,
            "filepath"_a,
            DOC(ConfigMerger, CreateFromFile))
        .def(
            "__deepcopy__",
            [](const ConstConfigMergerRcPtr & self, py::dict) {
                return self->createEditableCopy();
            },
            "memo"_a)
        ...
        .def(
            "setSearchPath",
            &ConfigMerger::setSearchPath,
            "path"_a,
            DOC(ConfigMerger, setSearchPath))
        .def(
            "addSearchPath",
            &ConfigMerger::addSearchPath,
            "path"_a,
            DOC(ConfigMerger, addSearchPath))
        .def(
            "getNumSearchPaths",
            &ConfigMerger::getNumSearchPaths,
            DOC(ConfigMerger, getNumSearchPaths))
        .def(
            "getSearchPath",
            &ConfigMerger::getSearchPath,
            "index"_a,
            DOC(ConfigMerger, getSearchPath))

        .def(
            "setWorkingDir",
            &ConfigMerger::setWorkingDir,
            "dirname"_a,
            DOC(ConfigMerger, setWorkingDir))
        .def("getWorkingDir", &ConfigMerger::getWorkingDir, DOC(ConfigMerger, getWorkingDir))
        .def("getParams", &ConfigMerger::getParams, "index"_a, DOC(ConfigMerger, getParams))
        .def(
            "getNumConfigMergingParameters",
            &ConfigMerger::getNumConfigMergingParameters,
            DOC(ConfigMerger, getNumConfigMergingParameters))
        .def("addParams", &ConfigMerger::addParams, "params"_a, DOC(ConfigMerger, addParams))
        .def("mergeConfigs", &ConfigMerger::mergeConfigs, DOC(ConfigMerger, mergeConfigs))
        .def(
            "getNumMergedConfigs",
            &ConfigMerger::getNumMergedConfigs,
        ...
        .def(
            "setVersion",
            &ConfigMerger::setVersion,
            "major"_a,
            "minor"_a,
            DOC(ConfigMerger, setVersion))
        .def("getMajorVersion", &ConfigMerger::getMajorVersion, DOC(ConfigMerger, getMajorVersion))
        .def("getMinorVersion", &ConfigMerger::getMinorVersion, DOC(ConfigMerger, getMinorVersion));
    ...
    mConfigMergingHelpers
        .def(
            "MergeConfigs",
            py::overload_cast<
                const ConfigMergingParametersRcPtr &,
                const ConstConfigRcPtr &,
                const ConstConfigRcPtr &>(&ConfigMergingHelpers::MergeConfigs),
            "params"_a,
            "baseConfig"_a,
            "inputConfig"_a,
