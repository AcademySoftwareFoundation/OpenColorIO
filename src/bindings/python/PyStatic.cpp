...
void bindPyStatic(py::module & m)
{
    ...
    py::enum_<OptimizationFlags>(m, "OptimizationFlags", py::arithmetic())
        ...
        .value("OPTIMIZATION_PAIR_IDENTITY_CLAMP", OPTIMIZATION_PAIR_IDENTITY_CLAMP)
    ...
    py::enum_<FinalizationFlags>(m, "FinalizationFlags")
        .value("FINALIZATION_EXACT", FINALIZATION_EXACT)
        .value("FINALIZATION_FAST", FINALIZATION_FAST)
        .value("FINALIZATION_DEFAULT", FINALIZATION_DEFAULT)
        .export_values();
