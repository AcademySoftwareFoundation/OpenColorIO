...
void bindPyLook(py::module & m)
{
    ...
    auto clsLook
        = py::class_<Look, LookRcPtr>(m.attr("Look"))

              .def(py::init(&Look::Create), DOC(Look, Create))
              .def(
                  py::init([](const std::string & name,
                      ...
                      {
                          p->setProcessSpace(processSpace.c_str());
                      }
                      if (transform)
                      {
                      ...
                      if (inverseTransform)
                      {
                          p->setInverseTransform(inverseTransform);
                      }
              ...
              .def(
                  "__deepcopy__",
                  [](const ConstLookRcPtr & self, py::dict) { return self->createEditableCopy(); },
                  "memo"_a)

              .def("getName", &Look::getName, DOC(Look, getName))
              .def("setName", &Look::setName, "name"_a.none(false), DOC(Look, setName))
              .def("getProcessSpace", &Look::getProcessSpace, DOC(Look, getProcessSpace))
              .def(
                  "setProcessSpace",
                  &Look::setProcessSpace,
                  "processSpace"_a.none(false),
                  DOC(Look, setProcessSpace))
              .def("getTransform", &Look::getTransform, DOC(Look, getTransform))
              .def("setTransform", &Look::setTransform, "transform"_a, DOC(Look, setTransform))
              .def(
                  "getInverseTransform",
              ...
              .def(
                  "setInverseTransform",
                  &Look::setInverseTransform,
                  "transform"_a,
                  DOC(Look, setInverseTransform))
              .def("getDescription", &Look::getDescription, DOC(Look, getDescription))
              .def(
                  "setDescription",
                  &Look::setDescription,
