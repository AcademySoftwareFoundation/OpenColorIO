...
void bindPyGpuShaderCreator(py::module & m)
{
    ...
    clsGpuShaderCreator
        ...
        .def("createShaderText", &GpuShaderCreator::createShaderText, 
             "classWrapHeader"_a, "shaderDeclarations"_a, "shaderHelperMethods"_a, "shaderFunctionHeader"_a,
             "shaderFunctionBody"_a, "shaderFunctionFooter"_a, "classWrapFooter"_a,
