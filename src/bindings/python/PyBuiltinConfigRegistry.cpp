...
namespace OCIO_NAMESPACE
{
    void bindPyBuiltinConfigRegistry(py::module & m)
    {
        ...
        clsBuiltinConfigRegistry
            ...
            .def(
                "getNumBuiltinConfigs",
                [](PyBuiltinConfigRegistry & self) 
                { 
            ...
            .def(
                "getBuiltinConfigName",
                [](PyBuiltinConfigRegistry & self, size_t configIndex) 
                { 
            ...
            .def(
                "getBuiltinConfigByName",
                [](PyBuiltinConfigRegistry & self, const char * configName) 
                { 
