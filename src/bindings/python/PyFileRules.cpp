...
{
    auto clsFileRules
        = py::class_<FileRules, FileRulesRcPtr>(m.attr("FileRules"))

              .def(py::init(&FileRules::Create), DOC(FileRules, Create))

              .def(
                  "__deepcopy__",
                  [](const ConstFileRulesRcPtr & self, py::dict) {
                      return self->createEditableCopy();
                  },
                  "memo"_a)

              .def("getNumEntries", &FileRules::getNumEntries, DOC(FileRules, getNumEntries))
              .def(
                  "getIndexForRule",
                  &FileRules::getIndexForRule,
                  "ruleName"_a,
                  DOC(FileRules, getIndexForRule))
              .def("getName", &FileRules::getName, "ruleIndex"_a, DOC(FileRules, getName))
              .def("getPattern", &FileRules::getPattern, "ruleIndex"_a, DOC(FileRules, getPattern))
              .def(
                  "setPattern",
                  &FileRules::setPattern,
                  "ruleIndex"_a,
                  "pattern"_a,
                  DOC(FileRules, setPattern))
              .def(
                  "getExtension",
                  &FileRules::getExtension,
                  "ruleIndex"_a,
                  DOC(FileRules, getExtension))
              .def(
                  "setExtension",
                  &FileRules::setExtension,
                  "ruleIndex"_a,
                  "extension"_a,
                  DOC(FileRules, setExtension))
              .def("getRegex", &FileRules::getRegex, "ruleIndex"_a, DOC(FileRules, getRegex))
              .def(
                  "setRegex",
                  &FileRules::setRegex,
                  "ruleIndex"_a,
              ...
              .def(
                  "getColorSpace",
                  &FileRules::getColorSpace,
                  "ruleIndex"_a,
                  DOC(FileRules, getColorSpace))
              .def(
                  "setColorSpace",
                  &FileRules::setColorSpace,
                  "ruleIndex"_a,
                  "colorSpace"_a,
                  DOC(FileRules, setColorSpace))
              .def(
                  "getNumCustomKeys",
                  &FileRules::getNumCustomKeys,
                  "ruleIndex"_a,
                  DOC(FileRules, getNumCustomKeys))
              .def(
                  "getCustomKeyName",
                  &FileRules::getCustomKeyName,
                  "ruleIndex"_a,
                  "key"_a,
                  DOC(FileRules, getCustomKeyName))
              .def(
                  "getCustomKeyValue",
                  &FileRules::getCustomKeyValue,
                  "ruleIndex"_a,
                  "key"_a,
                  DOC(FileRules, getCustomKeyValue))
              .def(
                  "setCustomKey",
                  &FileRules::setCustomKey,
                  "ruleIndex"_a,
                  "key"_a,
                  "value"_a,
              ...
              .def(
                  "insertRule",
                  (void(
                      FileRules::*)(size_t, const char *, const char *, const char *, const char *))
              ...
              .def(
                  ...
                  &FileRules::setDefaultRuleColorSpace,
                  "colorSpace"_a,
                  DOC(FileRules, setDefaultRuleColorSpace))
              .def("removeRule", &FileRules::removeRule, "ruleIndex"_a, DOC(FileRules, removeRule))
              .def(
                  "increaseRulePriority",
                  &FileRules::increaseRulePriority,
                  "ruleIndex"_a,
                  DOC(FileRules, increaseRulePriority))
              .def(
                  "decreaseRulePriority",
                  &FileRules::decreaseRulePriority,
                  "ruleIndex"_a,
