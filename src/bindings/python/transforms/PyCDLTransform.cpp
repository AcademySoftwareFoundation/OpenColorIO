...
void bindPyCDLTransform(py::module & m)
{
    ...
    auto clsCDLTransform
        = py::class_<CDLTransform, CDLTransformRcPtr, Transform>(m.attr("CDLTransform"))

              .def(py::init(&CDLTransform::Create), DOC(CDLTransform, Create))
              .def(
                  py::init([](TransformDirection dir) {
              ...
              .def(
                  py::init([](const std::array<double, 3> & slope,
                      ...
                      if (!desc.empty())
                      {
                          p->setFirstSOPDescription(desc.c_str());
                      }
                      p->setDirection(dir);
                      p->validate();
                      return p;
              ...
              .def("setStyle", &CDLTransform::setStyle, "style"_a, DOC(CDLTransform, setStyle))
              .def("equals", &CDLTransform::equals, "other"_a, DOC(CDLTransform, equals))
              .def("getStyle", &CDLTransform::getStyle, DOC(CDLTransform, getStyle))
              .def(
                  "getSlope",
                  [](ConstCDLTransformRcPtr self) {
              ...
              .def(
                  "setSlope",
                  [](CDLTransformRcPtr self, const std::array<double, 3> & rgb) {
              ...
              .def(
                  "setSOP",
                  [](CDLTransformRcPtr self, const std::array<double, 9> & vec9) {
                      self->setSOP(vec9.data());
                  },
                  "vec9"_a,
                  DOC(CDLTransform, setSOP))
              .def("getSat", &CDLTransform::getSat, DOC(CDLTransform, getSat))
              .def("setSat", &CDLTransform::setSat, "sat"_a, DOC(CDLTransform, setSat))
              .def(
                  "getSatLumaCoefs",
                  [](CDLTransformRcPtr self) {
                      std::array<double, 3> rgb;
              ...
              .def("getID", &CDLTransform::getID, DOC(CDLTransform, getID))
              .def("setID", &CDLTransform::setID, "id"_a.none(false), DOC(CDLTransform, setID))
              .def(
                  "getFirstSOPDescription",
                  &CDLTransform::getFirstSOPDescription,
                  DOC(CDLTransform, getFirstSOPDescription))
              .def(
                  "setFirstSOPDescription",
                  &CDLTransform::setFirstSOPDescription,
