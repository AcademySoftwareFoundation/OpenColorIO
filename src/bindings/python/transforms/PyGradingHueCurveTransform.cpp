...
void bindPyGradingHueCurveTransform(py::module & m)
{
    ...
    auto clsGradingHueCurveTransform
        = py::class_<GradingHueCurveTransform, GradingHueCurveTransformRcPtr, Transform>(
              ...
              .def(
                  py::init([](const ConstGradingHueCurveRcPtr & values,
                              GradingStyle style,
                              bool dynamic,
              ...
              .def(
                  py::init([](GradingStyle style, bool dynamic, TransformDirection dir) {
                      GradingHueCurveTransformRcPtr p = GradingHueCurveTransform::Create(style);
                      p->setStyle(style);
                      if (dynamic)
                      {
              ...
              .def(
                  "getStyle",
                  &GradingHueCurveTransform::getStyle,
                  DOC(GradingHueCurveTransform, getStyle))
              .def(
                  "setStyle",
                  &GradingHueCurveTransform::setStyle,
                  "style"_a,
                  DOC(GradingHueCurveTransform, setStyle))
              .def(
                  "getValue",
                  &GradingHueCurveTransform::getValue,
                  DOC(GradingHueCurveTransform, getValue))
              .def(
                  "setValue",
                  &GradingHueCurveTransform::setValue,
                  "values"_a,
                  DOC(GradingHueCurveTransform, setValue))
              .def(
                  "getSlope",
                  &GradingHueCurveTransform::getSlope,
                  "curve"_a,
                  "index"_a,
                  DOC(GradingHueCurveTransform, getSlope))
              .def(
                  "setSlope",
                  &GradingHueCurveTransform::setSlope,
                  "curve"_a,
                  "index"_a,
                  "slope"_a,
              ...
              .def(
                  "slopesAreDefault",
                  &GradingHueCurveTransform::slopesAreDefault,
                  "curve"_a,
                  DOC(GradingHueCurveTransform, slopesAreDefault))
              // TODO: The above follows what is in GradingRGBCurveTransform, but could add a more
              // pythonic version?
              //         .def("getSlopes", [](GradingHueCurveTransformRcPtr self, HueCurveType
              //         curveType)
              //             {
              ...
              //                 if (size != numPts)
              //                 {
              //                     throw Exception("Length of slopes vector must match number of
              //                     control points.");
              //                 }
              //                 for (size_t pt = 0; pt < numPts; ++pt)
              //                 {
              ...
              .def(
                  "getRGBToHSY",
                  &GradingHueCurveTransform::getRGBToHSY,
                  DOC(GradingHueCurveTransform, getRGBToHSY))
              .def(
                  "setRGBToHSY",
                  &GradingHueCurveTransform::setRGBToHSY,
                  "style"_a,
                  DOC(GradingHueCurveTransform, setRGBToHSY))
              .def(
                  "isDynamic",
                  &GradingHueCurveTransform::isDynamic,
                  DOC(GradingHueCurveTransform, isDynamic))
              .def(
                  "makeDynamic",
                  &GradingHueCurveTransform::makeDynamic,
                  DOC(GradingHueCurveTransform, makeDynamic))
              .def(
                  "makeNonDynamic",
                  &GradingHueCurveTransform::makeNonDynamic,
