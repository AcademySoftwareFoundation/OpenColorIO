...
void bindPyDisplayViewTransform(py::module & m)
{
    ...
    auto clsDisplayViewTransform
        = py::class_<DisplayViewTransform, DisplayViewTransformRcPtr, Transform>(
              ...
              .def(py::init(&DisplayViewTransform::Create), DOC(DisplayViewTransform, Create))
              .def(
                  py::init([](const std::string & src,
                      ...
                      if (!display.empty())
                      {
                          p->setDisplay(display.c_str());
                      }
                      if (!view.empty())
                      {
                          p->setView(view.c_str());
                      }
              ...
              .def("getSrc", &DisplayViewTransform::getSrc, DOC(DisplayViewTransform, getSrc))
              .def(
                  "setSrc",
                  &DisplayViewTransform::setSrc,
                  "src"_a,
                  DOC(DisplayViewTransform, setSrc))
              .def(
                  "getDisplay",
                  &DisplayViewTransform::getDisplay,
                  DOC(DisplayViewTransform, getDisplay))
              .def(
                  "setDisplay",
                  &DisplayViewTransform::setDisplay,
                  "display"_a,
                  DOC(DisplayViewTransform, setDisplay))
              .def("getView", &DisplayViewTransform::getView, DOC(DisplayViewTransform, getView))
              .def(
                  "setView",
                  &DisplayViewTransform::setView,
                  "view"_a,
                  DOC(DisplayViewTransform, setView))
              .def(
                  "getLooksBypass",
                  &DisplayViewTransform::getLooksBypass,
                  DOC(DisplayViewTransform, getLooksBypass))
              .def(
                  "setLooksBypass",
                  &DisplayViewTransform::setLooksBypass,
                  "looksBypass"_a,
                  DOC(DisplayViewTransform, setLooksBypass))
              .def(
                  "getDataBypass",
                  &DisplayViewTransform::getDataBypass,
                  DOC(DisplayViewTransform, getDataBypass))
              .def(
                  "setDataBypass",
                  &DisplayViewTransform::setDataBypass,
                  "dataBypass"_a,
