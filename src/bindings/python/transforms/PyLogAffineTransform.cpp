...
void bindPyLogAffineTransform(py::module & m)
{
    ...
    auto clsLogAffineTransform
        = py::class_<LogAffineTransform, LogAffineTransformRcPtr, Transform>(
              ...
              .def(py::init(&LogAffineTransform::Create), DOC(LogAffineTransform, Create))
              .def(
                  py::init([](const std::array<double, 3> & logSideSlope,
              ...
              .def(
                  "getFormatMetadata",
                  (FormatMetadata & (LogAffineTransform::*)())
              ...
              .def("getBase", &LogAffineTransform::getBase, DOC(LogAffineTransform, getBase))
              .def(
                  "setBase",
                  &LogAffineTransform::setBase,
                  "base"_a,
                  DOC(LogAffineTransform, setBase))
              .def(
                  "getLogSideSlopeValue",
                  [](LogAffineTransformRcPtr self) {
              ...
              .def(
                  ...
                  [](LogAffineTransformRcPtr self, const std::array<double, 3> & values) {
