...
void bindPyLut3DTransform(py::module & m)
{
    ...
    auto clsLut3DTransform
        = py::class_<Lut3DTransform, Lut3DTransformRcPtr, Transform>(m.attr("Lut3DTransform"))

              .def(py::init([]() { return Lut3DTransform::Create(); }), DOC(Lut3DTransform, Create))
              .def(
                  py::init([](unsigned long gridSize) { return Lut3DTransform::Create(gridSize); }),
                  "gridSize"_a,
                  DOC(Lut3DTransform, Create, 2))
              .def(
                  py::init([](unsigned long gridSize,
              ...
              .def(
                  ...
                  &Lut3DTransform::getFileOutputBitDepth,
                  DOC(Lut3DTransform, getFileOutputBitDepth))
              .def(
                  "setFileOutputBitDepth",
                  &Lut3DTransform::setFileOutputBitDepth,
                  "bitDepth"_a,
              ...
              .def("equals", &Lut3DTransform::equals, "other"_a, DOC(Lut3DTransform, equals))
              .def("getGridSize", &Lut3DTransform::getGridSize, DOC(Lut3DTransform, getGridSize))
              .def(
                  "setGridSize",
                  &Lut3DTransform::setGridSize,
                  "gridSize"_a,
                  DOC(Lut3DTransform, setGridSize))
              .def(
                  "getValue",
                  [](Lut3DTransformRcPtr & self,
              ...
              .def(
                  "setData",
                  [](Lut3DTransformRcPtr & self, py::buffer & data) {
              ...
              .def(
                  "getInterpolation",
                  &Lut3DTransform::getInterpolation,
                  DOC(Lut3DTransform, getInterpolation))
              .def(
                  "setInterpolation",
                  &Lut3DTransform::setInterpolation,
                  "interpolation"_a,
