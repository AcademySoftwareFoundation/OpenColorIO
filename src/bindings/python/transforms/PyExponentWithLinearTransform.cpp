...
void bindPyExponentWithLinearTransform(py::module & m)
{
    ...
    auto clsExponentWithLinearTransform
        = py::class_<ExponentWithLinearTransform, ExponentWithLinearTransformRcPtr, Transform>(
              ...
              .def(
                  py::init(&ExponentWithLinearTransform::Create),
                  DOC(ExponentWithLinearTransform, Create))
              .def(
                  py::init([](const std::array<double, 4> & gamma,
              ...
              .def(
                  "getGamma",
                  [](ExponentWithLinearTransformRcPtr self) {
              ...
              .def(
                  "setGamma",
                  [](ExponentWithLinearTransformRcPtr self, const std::array<double, 4> & values) {
              ...
              .def(
                  "getNegativeStyle",
                  &ExponentWithLinearTransform::getNegativeStyle,
                  DOC(ExponentWithLinearTransform, getNegativeStyle))
              .def(
                  "setNegativeStyle",
                  &ExponentWithLinearTransform::setNegativeStyle,
                  "style"_a,
