...
void bindPyGradingPrimaryTransform(py::module & m)
{
    ...
    auto clsGradingPrimaryTransform
        = py::class_<GradingPrimaryTransform, GradingPrimaryTransformRcPtr, Transform>(
              ...
              .def(
                  py::init([](const GradingPrimary & values,
                              GradingStyle style,
                              bool dynamic,
              ...
              .def(
                  "getStyle",
                  &GradingPrimaryTransform::getStyle,
                  DOC(GradingPrimaryTransform, getStyle))
              .def(
                  "setStyle",
                  &GradingPrimaryTransform::setStyle,
                  "style"_a,
                  DOC(GradingPrimaryTransform, setStyle))
              .def(
                  "getValue",
                  &GradingPrimaryTransform::getValue,
                  DOC(GradingPrimaryTransform, getValue))
              .def(
                  "setValue",
                  &GradingPrimaryTransform::setValue,
                  "values"_a,
                  DOC(GradingPrimaryTransform, setValue))
              .def(
                  "isDynamic",
                  &GradingPrimaryTransform::isDynamic,
                  DOC(GradingPrimaryTransform, isDynamic))
              .def(
                  "makeDynamic",
                  &GradingPrimaryTransform::makeDynamic,
                  DOC(GradingPrimaryTransform, makeDynamic))
              .def(
                  "makeNonDynamic",
                  &GradingPrimaryTransform::makeNonDynamic,
