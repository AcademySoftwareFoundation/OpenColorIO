...
void bindPyMatrixTransform(py::module & m)
{
    ...
    auto clsMatrixTransform
        = py::class_<MatrixTransform, MatrixTransformRcPtr, Transform>(m.attr("MatrixTransform"))

              .def(py::init(&MatrixTransform::Create), DOC(MatrixTransform, Create))
              .def(
                  py::init([](const std::array<double, 16> & m44,
              ...
              .def_static(
                  "Fit",
                  [](const std::array<double, 4> & oldmin4,
              ...
              .def_static(
                  "Sat",
                  [](double sat, const std::array<double, 3> & lumaCoef3) {
                      double m44[16];
                      double offset4[4];
              ...
              .def_static(
                  "Scale",
                  [](const std::array<double, 4> & scale4) {
                      double m44[16];
                      double offset4[4];
              ...
              .def_static(
                  "View",
                  [](std::array<int, 4> & channelHot4, const std::array<double, 3> & lumaCoef3) {
                      double m44[16];
                      double offset4[4];
              ...
              .def("equals", &MatrixTransform::equals, "other"_a, DOC(MatrixTransform, equals))
              .def(
                  "getMatrix",
                  [](MatrixTransformRcPtr self) {
              ...
              .def(
                  "setMatrix",
                  [](MatrixTransformRcPtr self, const std::array<double, 16> & m44) {
              ...
              .def(
                  "setOffset",
                  [](MatrixTransformRcPtr self, const std::array<double, 4> & offset4) {
              ...
              .def(
                  ...
                  &MatrixTransform::getFileInputBitDepth,
                  DOC(MatrixTransform, getFileInputBitDepth))
              .def(
                  "setFileInputBitDepth",
                  &MatrixTransform::setFileInputBitDepth,
                  "bitDepth"_a,
              ...
              .def(
                  ...
                  &MatrixTransform::setFileOutputBitDepth,
                  "bitDepth"_a,
