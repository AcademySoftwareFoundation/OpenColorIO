...
void bindPyLogCameraTransform(py::module & m)
{
    ...
    DEFAULT->getLogSideOffsetValue(
        *reinterpret_cast<double (*)[3]>(DEFAULT_LOG_SIDE_OFFSET.data()));
    ...
    DEFAULT->getLinSideOffsetValue(
        *reinterpret_cast<double (*)[3]>(DEFAULT_LIN_SIDE_OFFSET.data()));
    ...
    auto clsLogCameraTransform
        = py::class_<LogCameraTransform, LogCameraTransformRcPtr, Transform>(
              ...
              .def(
                  py::init([](const std::array<double, 3> & linSideBreak,
                              double base,
                      ...
                      LogCameraTransformRcPtr p = LogCameraTransform::Create(
                          *reinterpret_cast<const double (*)[3]>(linSideBreak.data()));
                      p->setBase(base);
                      p->setLogSideSlopeValue(
                          *reinterpret_cast<const double (*)[3]>(logSideSlope.data()));
                      p->setLogSideOffsetValue(
                          *reinterpret_cast<const double (*)[3]>(logSideOffset.data()));
                      p->setLinSideSlopeValue(
                          *reinterpret_cast<const double (*)[3]>(linSideSlope.data()));
                      p->setLinSideOffsetValue(
                          *reinterpret_cast<const double (*)[3]>(linSideOffset.data()));
                      ...
                      if (linearSlopeSize)
                      {
                          ...
                          p->setLinearSlopeValue(
                              *reinterpret_cast<const double (*)[3]>(linearSlope.data()));
                      }
                      p->setDirection(dir);
                      return p;
                  }),
              ...
              .def(
                  "getFormatMetadata",
                  (FormatMetadata & (LogCameraTransform::*)())
              ...
              .def("getBase", &LogCameraTransform::getBase, DOC(LogCameraTransform, getBase))
              .def(
                  "setBase",
                  &LogCameraTransform::setBase,
                  "base"_a,
                  DOC(LogCameraTransform, setBase))
              .def(
                  "getLogSideSlopeValue",
                  [](LogCameraTransformRcPtr self) {
              ...
              .def(
                  ...
                  [](LogCameraTransformRcPtr self, const std::array<double, 3> & values) {
                      self->setLogSideSlopeValue(
                          *reinterpret_cast<const double (*)[3]>(values.data()));
                  },
                  "values"_a,
              ...
              .def(
                  "setLinSideBreakValue",
                  [](LogCameraTransformRcPtr self, const std::array<double, 3> & values) {
                      self->setLinSideBreakValue(
                          *reinterpret_cast<const double (*)[3]>(values.data()));
                  },
                  "values"_a,
...
Return LinearSlope or 3 qnan values if not defined.
              ...
              .def(
                  "setLinearSlopeValue",
                  [](LogCameraTransformRcPtr self, const std::array<double, 3> & values) {
                      self->setLinearSlopeValue(
                          *reinterpret_cast<const double (*)[3]>(values.data()));
                  },
                  "values"_a,
                  DOC(LogCameraTransform, setLinearSlopeValue))
              .def(
                  "isLinearSlopeValueSet",
                  [](LogCameraTransformRcPtr self) {
                      std::array<double, 3> values;
                      return self->getLinearSlopeValue(
                          *reinterpret_cast<double (*)[3]>(values.data()));
                  })
              .def(
                  "unsetLinearSlopeValue",
                  &LogCameraTransform::unsetLinearSlopeValue,
