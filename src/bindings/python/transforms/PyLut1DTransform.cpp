...
void bindPyLut1DTransform(py::module & m)
{
    ...
    auto clsLut1DTransform
        = py::class_<Lut1DTransform, Lut1DTransformRcPtr, Transform>(m.attr("Lut1DTransform"))

              .def(py::init([]() { return Lut1DTransform::Create(); }), DOC(Lut1DTransform, Create))
              .def(
                  py::init([](unsigned long length, bool isHalfDomain) {
              ...
              .def(
                  ...
                  &Lut1DTransform::setFileOutputBitDepth,
                  "bitDepth"_a,
              ...
              .def("equals", &Lut1DTransform::equals, "other"_a, DOC(Lut1DTransform, equals))
              .def("getLength", &Lut1DTransform::getLength, DOC(Lut1DTransform, getLength))
              .def(
                  "setLength",
                  &Lut1DTransform::setLength,
                  "length"_a,
                  DOC(Lut1DTransform, setLength))
              .def(
                  "getValue",
                  [](Lut1DTransformRcPtr & self, unsigned long index) {
                      float r, g, b;
              ...
              .def(
                  "setData",
                  [](Lut1DTransformRcPtr & self, py::buffer & data) {
                      ...
                      unsigned long size
                          = (info.size >= 0 ? static_cast<unsigned long>(info.size) : 0);
              ...
              .def(
                  "getInputHalfDomain",
                  &Lut1DTransform::getInputHalfDomain,
                  DOC(Lut1DTransform, getInputHalfDomain))
              .def(
                  "setInputHalfDomain",
                  &Lut1DTransform::setInputHalfDomain,
                  "isHalfDomain"_a,
                  DOC(Lut1DTransform, setInputHalfDomain))
              .def(
                  "getOutputRawHalfs",
                  &Lut1DTransform::getOutputRawHalfs,
                  DOC(Lut1DTransform, getOutputRawHalfs))
              .def(
                  "setOutputRawHalfs",
                  &Lut1DTransform::setOutputRawHalfs,
                  "isRawHalfs"_a,
                  DOC(Lut1DTransform, setOutputRawHalfs))
              .def("getHueAdjust", &Lut1DTransform::getHueAdjust, DOC(Lut1DTransform, getHueAdjust))
              .def(
                  "setHueAdjust",
                  &Lut1DTransform::setHueAdjust,
                  "hueAdjust"_a,
                  DOC(Lut1DTransform, setHueAdjust))
              .def(
                  "getInterpolation",
                  &Lut1DTransform::getInterpolation,
                  DOC(Lut1DTransform, getInterpolation))
              .def(
                  "setInterpolation",
                  &Lut1DTransform::setInterpolation,
                  "interpolation"_a,
