...
void bindPyExposureContrastTransform(py::module & m)
{
    ...
    auto clsExposureContrastTransform
        = py::class_<ExposureContrastTransform, ExposureContrastTransformRcPtr, Transform>(
              ...
              .def(
                  py::init(&ExposureContrastTransform::Create),
                  DOC(ExposureContrastTransform, Create))
              .def(
                  py::init([](ExposureContrastStyle style,
                              double exposure,
                              double contrast,
                              double gamma,
                              double pivot,
                      ...
                      if (dynamicExposure)
                      {
                          p->makeExposureDynamic();
                      }
                      if (dynamicContrast)
                      {
                          p->makeContrastDynamic();
                      }
                      if (dynamicGamma)
                      {
                          p->makeGammaDynamic();
