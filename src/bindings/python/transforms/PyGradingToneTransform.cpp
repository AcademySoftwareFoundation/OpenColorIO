...
void bindPyGradingToneTransform(py::module & m)
{
    ...
    auto clsGradingToneTransform
        = py::class_<GradingToneTransform, GradingToneTransformRcPtr, Transform>(
              ...
              .def(
                  py::init([](const GradingTone & values,
                              GradingStyle style,
                              bool dynamic,
              ...
              .def("getStyle", &GradingToneTransform::getStyle, DOC(GradingToneTransform, getStyle))
              .def(
                  "setStyle",
                  &GradingToneTransform::setStyle,
                  "style"_a,
                  DOC(GradingToneTransform, setStyle))
              .def("getValue", &GradingToneTransform::getValue, DOC(GradingToneTransform, getValue))
              .def(
                  "setValue",
                  &GradingToneTransform::setValue,
                  "values"_a,
                  DOC(GradingToneTransform, setValue))
              .def(
                  "isDynamic",
                  &GradingToneTransform::isDynamic,
                  DOC(GradingToneTransform, isDynamic))
              .def(
                  "makeDynamic",
                  &GradingToneTransform::makeDynamic,
                  DOC(GradingToneTransform, makeDynamic))
              .def(
                  "makeNonDynamic",
                  &GradingToneTransform::makeNonDynamic,
