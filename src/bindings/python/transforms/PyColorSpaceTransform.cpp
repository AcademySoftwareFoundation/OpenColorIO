...
void bindPyColorSpaceTransform(py::module & m)
{
    ...
    auto clsColorSpaceTransform
        = py::class_<ColorSpaceTransform, ColorSpaceTransformRcPtr, Transform>(
              ...
              .def(py::init(&ColorSpaceTransform::Create), DOC(ColorSpaceTransform, Create))
              .def(
              ...
              .def("getSrc", &ColorSpaceTransform::getSrc, DOC(ColorSpaceTransform, getSrc))
              .def(
                  "setSrc",
                  &ColorSpaceTransform::setSrc,
                  "src"_a.none(false),
                  DOC(ColorSpaceTransform, setSrc))
              .def("getDst", &ColorSpaceTransform::getDst, DOC(ColorSpaceTransform, getDst))
              .def(
                  "setDst",
              ...
              .def(
                  "setDataBypass",
                  &ColorSpaceTransform::setDataBypass,
                  "dataBypass"_a,
