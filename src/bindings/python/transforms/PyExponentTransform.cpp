...
void bindPyExponentTransform(py::module & m)
{
    ...
    auto clsExponentTransform
        = py::class_<ExponentTransform, ExponentTransformRcPtr, Transform>(
              ...
              .def(py::init(&ExponentTransform::Create), DOC(ExponentTransform, Create))
              .def(
                  py::init([](const std::array<double, 4> & vec4,
              ...
              .def(
                  "getFormatMetadata",
                  (FormatMetadata & (ExponentTransform::*)())
                      & ExponentTransform::getFormatMetadata,
                  py::return_value_policy::reference_internal,
                  DOC(ExponentTransform, getFormatMetadata))
              .def("equals", &ExponentTransform::equals, "other"_a, DOC(ExponentTransform, equals))
              .def(
                  "getValue",
                  [](ExponentTransformRcPtr self) {
              ...
              .def(
                  "setValue",
                  [](ExponentTransformRcPtr self, const std::array<double, 4> & vec4) {
              ...
              .def(
                  "getNegativeStyle",
                  &ExponentTransform::getNegativeStyle,
                  DOC(ExponentTransform, getNegativeStyle))
              .def(
                  "setNegativeStyle",
                  &ExponentTransform::setNegativeStyle,
                  "style"_a,
