...
void bindPyGradingRGBCurveTransform(py::module & m)
{
    ...
    auto clsGradingRGBCurveTransform
        = py::class_<GradingRGBCurveTransform, GradingRGBCurveTransformRcPtr, Transform>(
              ...
              .def(
                  py::init([](const ConstGradingRGBCurveRcPtr & values,
                              GradingStyle style,
                              bool dynamic,
              ...
              .def(
                  "getStyle",
                  &GradingRGBCurveTransform::getStyle,
                  DOC(GradingRGBCurveTransform, getStyle))
              .def(
                  "setStyle",
                  &GradingRGBCurveTransform::setStyle,
                  "style"_a,
                  DOC(GradingRGBCurveTransform, setStyle))
              .def(
                  "getValue",
                  &GradingRGBCurveTransform::getValue,
                  DOC(GradingRGBCurveTransform, getValue))
              .def(
                  "setValue",
                  &GradingRGBCurveTransform::setValue,
                  "values"_a,
                  DOC(GradingRGBCurveTransform, setValue))
              .def(
                  "getSlope",
                  &GradingRGBCurveTransform::getSlope,
                  "channel"_a,
                  "index"_a,
                  DOC(GradingRGBCurveTransform, getSlope))
              .def(
                  "setSlope",
                  &GradingRGBCurveTransform::setSlope,
                  "channel"_a,
                  "index"_a,
                  "slope"_a,
              ...
              .def(
                  "slopesAreDefault",
                  &GradingRGBCurveTransform::slopesAreDefault,
                  "channel"_a,
                  DOC(GradingRGBCurveTransform, slopesAreDefault))
              .def(
                  "getBypassLinToLog",
                  &GradingRGBCurveTransform::getBypassLinToLog,
                  DOC(GradingRGBCurveTransform, getBypassLinToLog))
              .def(
                  "setBypassLinToLog",
                  &GradingRGBCurveTransform::setBypassLinToLog,
                  "bypass"_a,
                  DOC(GradingRGBCurveTransform, setBypassLinToLog))
              .def(
                  "isDynamic",
                  &GradingRGBCurveTransform::isDynamic,
                  DOC(GradingRGBCurveTransform, isDynamic))
              .def(
                  "makeDynamic",
                  &GradingRGBCurveTransform::makeDynamic,
                  DOC(GradingRGBCurveTransform, makeDynamic))
              .def(
                  "makeNonDynamic",
                  &GradingRGBCurveTransform::makeNonDynamic,
