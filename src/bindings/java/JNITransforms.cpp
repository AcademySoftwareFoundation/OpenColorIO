...
JNIEXPORT void JNICALL Java_org_OpenColorIO_Transform_dispose(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
...
Java_org_OpenColorIO_Transform_createEditableCopy(JNIEnv * env, jobject self)
{
    ...
    return BuildJObject<TransformRcPtr, TransformJNI>(
        env,
        self,
        env->FindClass(GetOCIOTClass(ctran)),
        ctran->createEditableCopy());
    OCIO_JNITRY_EXIT(NULL)
}

JNIEXPORT jobject JNICALL Java_org_OpenColorIO_Transform_getDirection(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
...
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<AllocationTransformRcPtr, AllocationTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/AllocationTransform"),
        AllocationTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    ConstAllocationTransformRcPtr alctran
        = GetConstJOCIO<ConstAllocationTransformRcPtr, AllocationTransformJNI>(env, self);
    return BuildJEnum(env, "org/OpenColorIO/Allocation", alctran->getAllocation());
    OCIO_JNITRY_EXIT(NULL)
}

JNIEXPORT void JNICALL Java_org_OpenColorIO_AllocationTransform_setAllocation(
    JNIEnv * env,
    jobject self,
    jobject allocation)
{
    OCIO_JNITRY_ENTER()
    AllocationTransformRcPtr alctran
        = GetEditableJOCIO<AllocationTransformRcPtr, AllocationTransformJNI>(env, self);
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_AllocationTransform_setVars(
    JNIEnv * env,
    jobject self,
    jint numvars,
    jfloatArray vars)
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_CDLTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<CDLTransformRcPtr, CDLTransformJNI>(
        env,
        self,
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_CDLTransform_CreateFromFile(
    JNIEnv * env,
    jobject self,
    jstring src,
    jstring cccid)
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_CDLTransform_getXML(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstCDLTransformRcPtr cdltran
        = GetConstJOCIO<ConstCDLTransformRcPtr, CDLTransformJNI>(env, self);
...
JNIEXPORT jfloat JNICALL Java_org_OpenColorIO_CDLTransform_getSat(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstCDLTransformRcPtr cdltran
        = GetConstJOCIO<ConstCDLTransformRcPtr, CDLTransformJNI>(env, self);
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_CDLTransform_getID(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstCDLTransformRcPtr cdltran
        = GetConstJOCIO<ConstCDLTransformRcPtr, CDLTransformJNI>(env, self);
...
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<ColorSpaceTransformRcPtr, ColorSpaceTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/ColorSpaceTransform"),
        ColorSpaceTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    ConstColorSpaceTransformRcPtr coltran
        = GetConstJOCIO<ConstColorSpaceTransformRcPtr, ColorSpaceTransformJNI>(env, self);
...
{
    OCIO_JNITRY_ENTER()
    ColorSpaceTransformRcPtr coltran
        = GetEditableJOCIO<ColorSpaceTransformRcPtr, ColorSpaceTransformJNI>(env, self);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_DisplayTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<DisplayTransformRcPtr, DisplayTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/DisplayTransform"),
        DisplayTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}

JNIEXPORT void JNICALL Java_org_OpenColorIO_DisplayTransform_setInputColorSpaceName(
    JNIEnv * env,
    jobject self,
    jstring name)
{
    OCIO_JNITRY_ENTER()
    DisplayTransformRcPtr dtran
        = GetEditableJOCIO<DisplayTransformRcPtr, DisplayTransformJNI>(env, self);
...
{
    OCIO_JNITRY_ENTER()
    ConstDisplayTransformRcPtr dtran
        = GetConstJOCIO<ConstDisplayTransformRcPtr, DisplayTransformJNI>(env, self);
...
Java_org_OpenColorIO_DisplayTransform_getLinearCC(JNIEnv * env, jobject self)
{
    ...
    return BuildJObject<TransformRcPtr, TransformJNI>(
        env,
        self,
        env->FindClass(GetOCIOTClass(cctran)),
        cctran->createEditableCopy());
    OCIO_JNITRY_EXIT(NULL)
}
...
Java_org_OpenColorIO_DisplayTransform_getChannelView(JNIEnv * env, jobject self)
{
    ...
    return BuildJObject<TransformRcPtr, TransformJNI>(
        env,
        self,
        env->FindClass(GetOCIOTClass(cvtran)),
        cvtran->createEditableCopy());
    OCIO_JNITRY_EXIT(NULL)
}
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_DisplayTransform_getView(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstDisplayTransformRcPtr dtran
        = GetConstJOCIO<ConstDisplayTransformRcPtr, DisplayTransformJNI>(env, self);
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_DisplayTransform_setLooksOverrideEnabled(
    JNIEnv * env,
    jobject self,
    jboolean enabled)
{
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_ExponentTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<TransformRcPtr, TransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/ExponentTransform"),
...
{
    OCIO_JNITRY_ENTER()
    ExponentTransformRcPtr exptran
        = GetEditableJOCIO<ExponentTransformRcPtr, ExponentTransformJNI>(env, self);
...
{
    OCIO_JNITRY_ENTER()
    ConstExponentTransformRcPtr exptran
        = GetConstJOCIO<ConstExponentTransformRcPtr, ExponentTransformJNI>(env, self);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_FileTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<FileTransformRcPtr, FileTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/FileTransform"),
        FileTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}

JNIEXPORT jstring JNICALL Java_org_OpenColorIO_FileTransform_getSrc(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstFileTransformRcPtr filetran
        = GetConstJOCIO<ConstFileTransformRcPtr, FileTransformJNI>(env, self);
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_FileTransform_getCCCId(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstFileTransformRcPtr filetran
        = GetConstJOCIO<ConstFileTransformRcPtr, FileTransformJNI>(env, self);
...
JNIEXPORT jint JNICALL Java_org_OpenColorIO_FileTransform_getNumFormats(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstFileTransformRcPtr filetran
        = GetConstJOCIO<ConstFileTransformRcPtr, FileTransformJNI>(env, self);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_GroupTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<GroupTransformRcPtr, GroupTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/GroupTransform"),
        GroupTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    ConstGroupTransformRcPtr gtran
        = GetConstJOCIO<ConstGroupTransformRcPtr, GroupTransformJNI>(env, self);
...
JNIEXPORT jint JNICALL Java_org_OpenColorIO_GroupTransform_size(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstGroupTransformRcPtr gtran
        = GetConstJOCIO<ConstGroupTransformRcPtr, GroupTransformJNI>(env, self);
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_GroupTransform_clear(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    GroupTransformRcPtr gtran = GetEditableJOCIO<GroupTransformRcPtr, GroupTransformJNI>(env, self);
    gtran->clear();
...
JNIEXPORT jboolean JNICALL Java_org_OpenColorIO_GroupTransform_empty(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstGroupTransformRcPtr gtran
        = GetConstJOCIO<ConstGroupTransformRcPtr, GroupTransformJNI>(env, self);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_LogTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<LogTransformRcPtr, LogTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/LogTransform"),
        LogTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}
...
JNIEXPORT jfloat JNICALL Java_org_OpenColorIO_LogTransform_getBase(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstLogTransformRcPtr ltran
        = GetConstJOCIO<ConstLogTransformRcPtr, LogTransformJNI>(env, self);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_LookTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<LookTransformRcPtr, LookTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/LookTransform"),
        LookTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}

JNIEXPORT jstring JNICALL Java_org_OpenColorIO_LookTransform_getSrc(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstLookTransformRcPtr lktran
        = GetConstJOCIO<ConstLookTransformRcPtr, LookTransformJNI>(env, self);
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_LookTransform_getDst(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstLookTransformRcPtr lktran
        = GetConstJOCIO<ConstLookTransformRcPtr, LookTransformJNI>(env, self);
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_LookTransform_getLooks(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstLookTransformRcPtr lktran
        = GetConstJOCIO<ConstLookTransformRcPtr, LookTransformJNI>(env, self);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_MatrixTransform_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return BuildJObject<MatrixTransformRcPtr, MatrixTransformJNI>(
        env,
        self,
        env->FindClass("org/OpenColorIO/MatrixTransform"),
        MatrixTransform::Create());
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    ConstMatrixTransformRcPtr left
        = GetConstJOCIO<ConstMatrixTransformRcPtr, MatrixTransformJNI>(env, self);
    ConstMatrixTransformRcPtr right
        = GetConstJOCIO<ConstMatrixTransformRcPtr, MatrixTransformJNI>(env, obj);
    return (jboolean)left->equals(*right.get());
    OCIO_JNITRY_EXIT(false)
}

JNIEXPORT void JNICALL Java_org_OpenColorIO_MatrixTransform_setValue(
    JNIEnv * env,
    jobject self,
    jfloatArray m44,
    jfloatArray offset4)
{
    OCIO_JNITRY_ENTER()
    MatrixTransformRcPtr mtran
        = GetEditableJOCIO<MatrixTransformRcPtr, MatrixTransformJNI>(env, self);
    mtran->setValue(
        GetJFloatArrayValue(env, m44, "m44", 16)(),
        GetJFloatArrayValue(env, offset4, "offset4", 4)());
    OCIO_JNITRY_EXIT()
}

JNIEXPORT void JNICALL Java_org_OpenColorIO_MatrixTransform_getValue(
    JNIEnv * env,
    jobject self,
    jfloatArray m44,
    jfloatArray offset4)
{
    OCIO_JNITRY_ENTER()
    ConstMatrixTransformRcPtr mtran
        = GetConstJOCIO<ConstMatrixTransformRcPtr, MatrixTransformJNI>(env, self);
    mtran->getValue(
        SetJFloatArrayValue(env, m44, "m44", 16)(),
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_MatrixTransform_Fit(
    JNIEnv * env,
    jobject self,
    jfloatArray m44,
    jfloatArray offset4,
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_MatrixTransform_Identity(
    JNIEnv * env,
    jobject self,
    jfloatArray m44,
    jfloatArray offset4)
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_MatrixTransform_Sat(
    JNIEnv * env,
    jobject self,
    jfloatArray m44,
    jfloatArray offset4,
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_MatrixTransform_Scale(
    JNIEnv * env,
    jobject self,
    jfloatArray m44,
    jfloatArray offset4,
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_MatrixTransform_View(
    JNIEnv * env,
    jobject self,
    jfloatArray m44,
    jfloatArray offset4,
    jintArray channelHot4,
    jfloatArray lumaCoef3)
{
    OCIO_JNITRY_ENTER()
    ConstMatrixTransformRcPtr mtran
