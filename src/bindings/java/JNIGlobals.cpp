...
JNIEXPORT void JNICALL Java_org_OpenColorIO_Globals_create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    jfieldID fid;
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_Globals_ClearAllCaches(JNIEnv * env, jobject)
{
    OCIO_JNITRY_ENTER()
    ClearAllCaches();
    OCIO_JNITRY_EXIT()
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_Globals_GetVersion(JNIEnv * env, jobject)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT jint JNICALL Java_org_OpenColorIO_Globals_GetVersionHex(JNIEnv * env, jobject)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_Globals_GetLoggingLevel(JNIEnv * env, jobject)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_Globals_GetCurrentConfig(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    jobject obj = BuildJConstObject<ConstConfigRcPtr, ConfigJNI>(
        env,
        self,
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_LoggingLevel_toString(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(LoggingLevelToString(GetJEnum<LoggingLevel>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<LoggingLevel>(env, self) == GetJEnum<LoggingLevel>(env, obj);
    OCIO_JNITRY_EXIT(false)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(LoggingLevelToString(GetJEnum<LoggingLevel>(env, level)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(TransformDirectionToString(GetJEnum<TransformDirection>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<TransformDirection>(env, self) == GetJEnum<TransformDirection>(env, obj);
    OCIO_JNITRY_EXIT(false)
}

JNIEXPORT jstring JNICALL
Java_org_OpenColorIO_Globals_TransformDirectionToString(JNIEnv * env, jobject, jobject dir)
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(TransformDirectionToString(GetJEnum<TransformDirection>(env, dir)));
    OCIO_JNITRY_EXIT(NULL)
}

JNIEXPORT jobject JNICALL
Java_org_OpenColorIO_Globals_TransformDirectionFromString(JNIEnv * env, jobject, jstring s)
{
    OCIO_JNITRY_ENTER()
    return BuildJEnum(
        env,
...
JNIEXPORT jobject JNICALL
Java_org_OpenColorIO_Globals_GetInverseTransformDirection(JNIEnv * env, jobject, jobject dir)
{
    OCIO_JNITRY_ENTER()
    return BuildJEnum(
        env,
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_Globals_CombineTransformDirections(
    JNIEnv * env,
    jobject,
    jobject d1,
    jobject d2)
{
    ...
    return BuildJEnum(
        ...
        CombineTransformDirections(
            GetJEnum<TransformDirection>(env, d1),
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(ColorSpaceDirectionToString(GetJEnum<ColorSpaceDirection>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<ColorSpaceDirection>(env, self) == GetJEnum<ColorSpaceDirection>(env, obj);
    OCIO_JNITRY_EXIT(false)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(ColorSpaceDirectionToString(GetJEnum<ColorSpaceDirection>(env, dir)));
    OCIO_JNITRY_EXIT(NULL)
}
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_BitDepth_toString(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(BitDepthToString(GetJEnum<BitDepth>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<BitDepth>(env, self) == GetJEnum<BitDepth>(env, obj);
    OCIO_JNITRY_EXIT(false)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(BitDepthToString(GetJEnum<BitDepth>(env, bitDepth)));
    OCIO_JNITRY_EXIT(NULL)
}
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_Allocation_toString(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(AllocationToString(GetJEnum<Allocation>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<Allocation>(env, self) == GetJEnum<Allocation>(env, obj);
    OCIO_JNITRY_EXIT(false)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(AllocationToString(GetJEnum<Allocation>(env, allocation)));
    OCIO_JNITRY_EXIT(NULL)
}
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_Interpolation_toString(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(InterpolationToString(GetJEnum<Interpolation>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<Interpolation>(env, self) == GetJEnum<Interpolation>(env, obj);
    OCIO_JNITRY_EXIT(false)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(InterpolationToString(GetJEnum<Interpolation>(env, interp)));
    OCIO_JNITRY_EXIT(NULL)
}
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_GpuLanguage_toString(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(GpuLanguageToString(GetJEnum<GpuLanguage>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<GpuLanguage>(env, self) == GetJEnum<GpuLanguage>(env, obj);
    OCIO_JNITRY_EXIT(false)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(GpuLanguageToString(GetJEnum<GpuLanguage>(env, language)));
    OCIO_JNITRY_EXIT(NULL)
}
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_EnvironmentMode_toString(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(EnvironmentModeToString(GetJEnum<EnvironmentMode>(env, self)));
    OCIO_JNITRY_EXIT(NULL)
}
...
{
    OCIO_JNITRY_ENTER()
    return GetJEnum<EnvironmentMode>(env, self) == GetJEnum<EnvironmentMode>(env, obj);
    OCIO_JNITRY_EXIT(false)
}
...
{
    OCIO_JNITRY_ENTER()
    return env->NewStringUTF(EnvironmentModeToString(GetJEnum<EnvironmentMode>(env, mode)));
    OCIO_JNITRY_EXIT(NULL)
}
