...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_Processor_Create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    jobject obj = BuildJConstObject<ConstProcessorRcPtr, ProcessorJNI>(
        env,
        self,
...
JNIEXPORT jboolean JNICALL Java_org_OpenColorIO_Processor_isNoOp(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_Processor_apply(JNIEnv * env, jobject self, jobject img)
{
    OCIO_JNITRY_ENTER()
    ConstProcessorRcPtr ptr = GetConstJOCIO<ConstProcessorRcPtr, ProcessorJNI>(env, self);
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_Processor_getCpuCacheID(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstProcessorRcPtr ptr = GetConstJOCIO<ConstProcessorRcPtr, ProcessorJNI>(env, self);
...
Java_org_OpenColorIO_Processor_getGpuShaderText(JNIEnv * env, jobject self, jobject shaderDesc)
{
    OCIO_JNITRY_ENTER()
    ConstProcessorRcPtr ptr = GetConstJOCIO<ConstProcessorRcPtr, ProcessorJNI>(env, self);
    ConstGpuShaderDescRcPtr desc
        = GetConstJOCIO<ConstGpuShaderDescRcPtr, GpuShaderDescJNI>(env, shaderDesc);
    return env->NewStringUTF(ptr->getGpuShaderText(*desc.get()));
    OCIO_JNITRY_EXIT(NULL)
}

JNIEXPORT jstring JNICALL Java_org_OpenColorIO_Processor_getGpuShaderTextCacheID(
    JNIEnv * env,
    jobject self,
    jobject shaderDesc)
{
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_Processor_getGpuLut3D(
    JNIEnv * env,
    jobject self,
    jobject lut3d,
    jobject shaderDesc)
