...
JNIEXPORT void JNICALL Java_org_OpenColorIO_GpuShaderDesc_create(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_GpuShaderDesc_dispose(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_GpuShaderDesc_getLanguage(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstGpuShaderDescRcPtr ptr
        = GetConstJOCIO<ConstGpuShaderDescRcPtr, GpuShaderDescJNI>(env, self);
...
JNIEXPORT jstring JNICALL Java_org_OpenColorIO_GpuShaderDesc_getCacheID(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstGpuShaderDescRcPtr ptr
        = GetConstJOCIO<ConstGpuShaderDescRcPtr, GpuShaderDescJNI>(env, self);
