...
JNIEXPORT void JNICALL Java_org_OpenColorIO_PackedImageDesc_create__Ljava_nio_FloatBuffer_2JJJ(
    JNIEnv * env,
    jobject self,
    jobject data,
    jlong width,
    ...
    jlong numChannels)
{
    ...
    if (!_data)
        throw Exception("Could not find direct buffer address for data");
    ...
    *jnistruct->cppobj       = ImageDescRcPtr(
        new PackedImageDesc(_data, (long)width, (long)height, (long)numChannels),
        &ImageDesc_deleter);
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_PackedImageDesc_create__Ljava_nio_FloatBuffer_2JJJJJJ(
    JNIEnv * env,
    jobject self,
    jobject data,
    jlong width,
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_PackedImageDesc_dispose(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_PackedImageDesc_getData(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
...
JNIEXPORT jlong JNICALL Java_org_OpenColorIO_PackedImageDesc_getWidth(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
    ConstPackedImageDescRcPtr ptr = DynamicPtrCast<const PackedImageDesc>(img);
...
JNIEXPORT jlong JNICALL Java_org_OpenColorIO_PackedImageDesc_getHeight(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
    ConstPackedImageDescRcPtr ptr = DynamicPtrCast<const PackedImageDesc>(img);
...
JNIEXPORT void JNICALL Java_org_OpenColorIO_PlanarImageDesc_dispose(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ImageDesc_dispose(env, self);
    OCIO_JNITRY_EXIT()
    ...
    jlong height)
{
    ...
    if (!_rdata)
        throw Exception("Could not find direct buffer address for rData");
    float * _gdata = GetJFloatBuffer(env, gData, size);
    if (!_gdata)
        throw Exception("Could not find direct buffer address for gData");
    float * _bdata = GetJFloatBuffer(env, bData, size);
    if (!_bdata)
        throw Exception("Could not find direct buffer address for bData");
    float * _adata = GetJFloatBuffer(env, aData, size);
    if (!_adata)
        throw Exception("Could not find direct buffer address for aData");
    ImageDescJNI * jnistruct = new ImageDescJNI();
    jnistruct->back_ptr      = env->NewGlobalRef(self);
    jnistruct->constcppobj   = new ConstImageDescRcPtr();
    jnistruct->cppobj        = new ImageDescRcPtr();
    *jnistruct->cppobj       = ImageDescRcPtr(
        new PlanarImageDesc(_rdata, _gdata, _bdata, _adata, (long)width, (long)height),
        &ImageDesc_deleter);
    jnistruct->isconst = false;
    jclass wclass      = env->GetObjectClass(self);
    jfieldID fid       = env->GetFieldID(wclass, "m_impl", "J");
...
JNIEXPORT void JNICALL
Java_org_OpenColorIO_PlanarImageDesc_create__Ljava_nio_FloatBuffer_2Ljava_nio_FloatBuffer_2Ljava_nio_FloatBuffer_2Ljava_nio_FloatBuffer_2JJJ(
    JNIEnv * env,
    jobject self,
    jobject rData,
    jobject gData,
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_PlanarImageDesc_getRData(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_PlanarImageDesc_getGData(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
    ConstPlanarImageDescRcPtr ptr = DynamicPtrCast<const PlanarImageDesc>(img);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_PlanarImageDesc_getBData(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
    ConstPlanarImageDescRcPtr ptr = DynamicPtrCast<const PlanarImageDesc>(img);
...
JNIEXPORT jobject JNICALL Java_org_OpenColorIO_PlanarImageDesc_getAData(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
    ConstPlanarImageDescRcPtr ptr = DynamicPtrCast<const PlanarImageDesc>(img);
...
JNIEXPORT jlong JNICALL Java_org_OpenColorIO_PlanarImageDesc_getWidth(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
    ConstPlanarImageDescRcPtr ptr = DynamicPtrCast<const PlanarImageDesc>(img);
...
JNIEXPORT jlong JNICALL Java_org_OpenColorIO_PlanarImageDesc_getHeight(JNIEnv * env, jobject self)
{
    OCIO_JNITRY_ENTER()
    ConstImageDescRcPtr img       = GetConstJOCIO<ConstImageDescRcPtr, ImageDescJNI>(env, self);
    ConstPlanarImageDescRcPtr ptr = DynamicPtrCast<const PlanarImageDesc>(img);
