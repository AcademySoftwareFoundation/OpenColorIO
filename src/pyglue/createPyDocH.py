...
"""
This script contains mock OpenColourIO classes which define the __doc__
...
if __name__ == "__main__":
    ...
    fileh.write("\n")
    fileh.write("#include <OpenColourIO/OpenColourIO.h>\n")
    fileh.write("\n")
    ...
    fileh.write("%s\n" % GetDocStrings(OpenColourIO))
    fileh.write("%s\n" % GetDocStrings(Constants))
    fileh.write("%s\n" % GetDocStrings(Config))
    #fileh.write("%s\n" % GetDocStrings(Baker))
    fileh.write("%s\n" % GetDocStrings(ColourSpace))
    ...
    fileh.write("%s\n" % GetDocStrings(ColourSpaceTransform))
