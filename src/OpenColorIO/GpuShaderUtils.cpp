...
{
    newLine() << (m_lang == GPU_LANGUAGE_MSL_2_0 ? "" : "uniform ") << floatKeyword() << " "
              << uniformName << ";";
}
...
{
    newLine() << (m_lang == GPU_LANGUAGE_MSL_2_0 ? "" : "uniform ") << float3Keyword() << " "
              << uniformName << ";";
}
...
{
    newLine() << (m_lang == GPU_LANGUAGE_MSL_2_0 ? "" : "uniform ") << intKeyword() << " "
              << uniformName << "[" << size << "];";
}
...
std::string GpuShaderText::float3GreaterThan(const std::string & a, const std::string & b) const
{
    ...
    switch (m_lang)
    {
        ...
        case GPU_LANGUAGE_HLSL_DX11:
        {
            kw << float3Keyword() << "(" << "(" << a << "[0] > " << b << "[0]) ? 1.0 : 0.0, " << "("
               << a << "[1] > " << b << "[1]) ? 1.0 : 0.0, " << "(" << a << "[2] > " << b
               << "[2]) ? 1.0 : 0.0)";
            break;
        }
...
std::string GpuShaderText::float4GreaterThan(const std::string & a, const std::string & b) const
{
    ...
    switch (m_lang)
    {
        ...
        case GPU_LANGUAGE_HLSL_DX11:
        {
            kw << float4Keyword() << "(" << "(" << a << "[0] > " << b << "[0]) ? 1.0 : 0.0, " << "("
               << a << "[1] > " << b << "[1]) ? 1.0 : 0.0, " << "(" << a << "[2] > " << b
               << "[2]) ? 1.0 : 0.0, " << "(" << a << "[3] > " << b << "[3]) ? 1.0 : 0.0)";
            break;
        }
        case LANGUAGE_OSL_1:
        {
            kw << float4Keyword() << "(" << "(" << a << ".rgb.r > " << b << ".x) ? 1.0 : 0.0, "
               << "(" << a << ".rgb.g > " << b << ".y) ? 1.0 : 0.0, " << "(" << a << ".rgb.b > "
               << b << ".z) ? 1.0 : 0.0, " << "(" << a << ".a > " << b << ".w) ? 1.0 : 0.0)";
            break;
        }
