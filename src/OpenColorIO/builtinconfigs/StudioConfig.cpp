...
void Register(BuiltinConfigRegistryImpl & registry) noexcept
{
    ...
    registry.addBuiltin(
        ...
        "Academy Color Encoding System - Studio Config [COLORSPACES v2.2.0] [ACES v1.3] [OCIO "
        "v2.4]",
    ...
    registry.addBuiltin(
        ...
        "Academy Color Encoding System - Studio Config [COLORSPACES v4.0.0] [ACES v2.0] [OCIO "
        "v2.5]",
