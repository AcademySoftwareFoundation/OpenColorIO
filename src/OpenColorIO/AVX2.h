...
inline void avx2RGBATranspose_4x4_4x4(
    __m256 row0,
    __m256 row1,
    __m256 row2,
    __m256 row3,
...
template <> struct AVX2RGBAPack<BIT_DEPTH_UINT8>
{
    static inline void Load(const uint8_t * in, __m256 & r, __m256 & g, __m256 & b, __m256 & a)
    {
        ...
        __m256 rgba1 = _mm256_cvtepi32_ps(
            _mm256_cvtepu8_epi32(_mm_shuffle_epi32(rgba_00_03, _MM_SHUFFLE(3, 2, 3, 2))));

        __m256 rgba2 = _mm256_cvtepi32_ps(_mm256_cvtepu8_epi32(rgba_04_07));
        __m256 rgba3 = _mm256_cvtepi32_ps(
            _mm256_cvtepu8_epi32(_mm_shuffle_epi32(rgba_04_07, _MM_SHUFFLE(3, 2, 3, 2))));
    ...
    static inline void Store(uint8_t * out, __m256 r, __m256 g, __m256 b, __m256 a)
    {
        ...
        __m128i lo
            = _mm_or_si128(_mm256_castsi256_si128(rgba01), _mm256_extractf128_si256(rgba01, 1));
        ...
        __m128i hi
            = _mm_or_si128(_mm256_castsi256_si128(rgba45), _mm256_extractf128_si256(rgba45, 1));
...
template <BitDepth BD> struct AVX2RGBAPack16
{
    ...
    static inline void Load(const Type * in, __m256 & r, __m256 & g, __m256 & b, __m256 & a)
    {
        ...
        __m256 rgba0
            = _mm256_cvtepi32_ps(_mm256_cvtepu16_epi32(_mm256_castsi256_si128(rgba_00_03)));
        __m256 rgba1
            = _mm256_cvtepi32_ps(_mm256_cvtepu16_epi32(_mm256_extractf128_si256(rgba_00_03, 1)));
        __m256 rgba2
            = _mm256_cvtepi32_ps(_mm256_cvtepu16_epi32(_mm256_castsi256_si128(rgba_04_07)));
        __m256 rgba3
            = _mm256_cvtepi32_ps(_mm256_cvtepu16_epi32(_mm256_extractf128_si256(rgba_04_07, 1)));
...
template <> struct AVX2RGBAPack<BIT_DEPTH_UINT10>
{
...
template <> struct AVX2RGBAPack<BIT_DEPTH_UINT12>
{
    static inline void Load(const uint16_t * in, __m256 & r, __m256 & g, __m256 & b, __m256 & a)
    {
...
template <> struct AVX2RGBAPack<BIT_DEPTH_UINT16>
{
    static inline void Load(const uint16_t * in, __m256 & r, __m256 & g, __m256 & b, __m256 & a)
    {
...
template <> struct AVX2RGBAPack<BIT_DEPTH_F16>
{
...
template <> struct AVX2RGBAPack<BIT_DEPTH_F32>
{
