...
private:
    ...
    static void
    StartElementHandler(void * userData, const XML_Char * name_full, const XML_Char ** atts)
    {
        ...
        else
        {
                    ...
                    recognizedName))
            {
                ...
                SupportedElement(name, pElt, TAG_FIXED_FUNCTION, TAG_PROCESS_LIST, recognizedName))
            {
            ...
            else if (SupportedElement(name, pElt, TAG_HUE_CURVE, TAG_PROCESS_LIST, recognizedName))
            {
            ...
            else
            {
                        ...
                        recognizedName))
                {
                    ...
                    SupportedElement(name, pElt, gradingToneSubElements, TAG_TONE, recognizedName))
                {
                    pImpl->m_elms.push_back(
    ...
    static void EndElementHandler(void * userData, const XML_Char * name_full)
    {
        XMLParserHelper * pImpl = (XMLParserHelper *)userData;
        if (!pImpl || !name_full || !*name_full)
        {
