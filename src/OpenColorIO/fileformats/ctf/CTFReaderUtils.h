...
static constexpr char TAG_HUE_CURVE[] = "HueCurve";
static constexpr char TAG_HUE_CURVE_HUE_HUE[] = "hue_hue";
static constexpr char TAG_HUE_CURVE_HUE_SAT[] = "hue_sat";
static constexpr char TAG_HUE_CURVE_HUE_LUM[] = "hue_lum";
static constexpr char TAG_HUE_CURVE_LUM_SAT[] = "lum_sat";
static constexpr char TAG_HUE_CURVE_SAT_SAT[] = "sat_sat";
static constexpr char TAG_HUE_CURVE_LUM_LUM[] = "lum_lum";
static constexpr char TAG_HUE_CURVE_SAT_LUM[] = "sat_lum";
static constexpr char TAG_HUE_CURVE_HUE_FX[] = "hue_fx";
