    ...
    int size1d   = 0;
    {
        ...
        while (nextline(istream, line))
        {
            ...
            if (StringUtils::StartsWith(parts[0], '#'))
            {
                ...
                if (parts[1] == "width")
                {
                    if (parts.size() != 5 || !StringToInt(&size3d[0], parts[2].c_str())
                ...
                {
                    if (parts.size() != 3 || !StringToInt(&size1d, parts[2].c_str()))
                    {
