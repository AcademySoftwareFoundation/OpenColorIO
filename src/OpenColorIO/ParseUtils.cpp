...
const char * FixedFunctionStyleToString(FixedFunctionStyle style)
{
    switch(style)
    {
        ...
        case FIXED_FUNCTION_LINEAR_TO_PQ:                   return "LINEAR_TO_PQ";
        case FIXED_FUNCTION_LINEAR_TO_HLG:                  return "LINEAR_TO_HLG";
        case FIXED_FUNCTION_LINEAR_TO_DOUBLE_LOG_AFFINE:    return "LINEAR_TO_DOUBLE_LOG_AFFINE";
...
FixedFunctionStyle FixedFunctionStyleFromString(const char * style)
{
    ...
    else if(str == "linear_to_pq")                  return FIXED_FUNCTION_LINEAR_TO_PQ;
    else if(str == "linear_to_hlg")                 return FIXED_FUNCTION_LINEAR_TO_HLG;
    else if(str == "linear_to_double_log_affine")   return FIXED_FUNCTION_LINEAR_TO_DOUBLE_LOG_AFFINE;
