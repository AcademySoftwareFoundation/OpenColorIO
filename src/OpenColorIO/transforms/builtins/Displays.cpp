...
void RegisterAll(BuiltinTransformRegistryImpl & registry) noexcept
{
...

    {
        ...
        ConversionFunctor CIE_XYZ_D65_to_SRGB_MONCURVE = [CIE_XYZ_D65_to_SRGB](OpRcPtrVec & ops) {
        ...
        ConversionFunctor CIE_XYZ_D65_to_SRGB_MIRROR = [CIE_XYZ_D65_to_SRGB](OpRcPtrVec & ops) {
...

    {
        ...
        ConversionFunctor CIE_XYZ_D65_to_P3_D65_BASIC = [CIE_XYZ_D65_to_P3_D65](OpRcPtrVec & ops) {
        ...
        ConversionFunctor CIE_XYZ_D65_to_P3_D65_MIRROR = [CIE_XYZ_D65_to_P3_D65](OpRcPtrVec & ops) {
...

    {
        ...
        // NOTE: This builtin is defined to be able to partition SDR and HDR view transforms under
        // two separate displays rather than a single one.
        registry.addBuiltin(
    ...
    {
        auto ST2084_to_Linear_Functor
            = [](OpRcPtrVec & ops) { ST_2084::GeneratePQToLinearOps(ops); };
    ...
    {
        auto Linear_to_ST2084_Functor
            = [](OpRcPtrVec & ops) { ST_2084::GenerateLinearToPQOps(ops); };
    ...
    {
        auto CIE_XYZ_D65_to_ST2084_DCDM_D65_Functor
            = [](OpRcPtrVec & ops) { ST_2084::GenerateLinearToPQOps(ops); };
    ...
    {
        auto HLG_to_Linear_Functor = [](OpRcPtrVec & ops) { HLG::GenerateHLGToLinearOps(ops); };
    ...
    {
        auto Linear_to_HLG_Functor = [](OpRcPtrVec & ops) { HLG::GenerateLinearToHLGOps(ops); };
