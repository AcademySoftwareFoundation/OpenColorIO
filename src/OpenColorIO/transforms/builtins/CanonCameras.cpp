...
void RegisterAll(BuiltinTransformRegistryImpl & registry) noexcept
{
    ...
    {
        auto CANON_CLOG2_to_Linear_Functor
            = [](OpRcPtrVec & ops) { CreateLut(ops, 4096, CANON_CLOG2::GenerateLutValues); };
    ...
    {
        auto CANON_CLOG3_to_Linear_Functor
            = [](OpRcPtrVec & ops) { CreateLut(ops, 4096, CANON_CLOG3::GenerateLutValues); };
