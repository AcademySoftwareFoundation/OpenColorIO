...
void AddCameraLogToLinShader(GpuShaderDescRcPtr & shaderDesc,
                             ConstLogOpDataRcPtr & logData)
{
    // if in <= logBreak
...
void AddCameraLinToLogShader(GpuShaderDescRcPtr & shaderDesc,
                             ConstLogOpDataRcPtr & logData)
{
    // if in <= linBreak
                            ...
                            ConstLogOpDataRcPtr & logData)
{
    ...
    else
    {
        if (logData->isCamera())
        {
            if (dir == TRANSFORM_DIR_FORWARD)
            {
                AddCameraLinToLogShader(shaderDesc, logData);
            }
            else
            {
                AddCameraLogToLinShader(shaderDesc, logData);
            }
        }
        else
        {
