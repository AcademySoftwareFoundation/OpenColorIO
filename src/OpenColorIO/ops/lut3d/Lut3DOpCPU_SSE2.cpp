...
static inline rgbavec_sse2
interp_tetrahedral_sse2(const Lut3DContextSSE2 & ctx, __m128 r, __m128 g, __m128 b, __m128 a)
{
...
static inline void applyTetrahedralSSE2Func(
    const float * lut3d,
    int dim,
    const float * src,
    float * dst,
