...
inline void avx512RGBATranspose_4x4_4x4_4x4_4x4(
    __m512 row0,
    __m512 row1,
    __m512 row2,
    __m512 row3,
...
template <> struct AVX512RGBAPack<BIT_DEPTH_UINT8>
{
    ...
    static inline void
    StoreMasked(uint8_t * out, __m512 r, __m512 g, __m512 b, __m512 a, uint32_t pixel_count)
    {
        const __m512 maxValue = _mm512_set1_ps(255.0f);
        __m512 rgba0, rgba1, rgba2, rgba3;
...
template <BitDepth BD> struct AVX512RGBAPack16
{
    ...
    static inline void Load(const Type * in, __m512 & r, __m512 & g, __m512 & b, __m512 & a)
    {
        ...
        __m512 rgba0
            = _mm512_cvtepi32_ps(_mm512_cvtepu16_epi32(_mm512_castsi512_si256(rgba_00_07)));
        __m512 rgba1
            = _mm512_cvtepi32_ps(_mm512_cvtepu16_epi32(_mm512_extracti64x4_epi64(rgba_00_07, 1)));
        __m512 rgba2
            = _mm512_cvtepi32_ps(_mm512_cvtepu16_epi32(_mm512_castsi512_si256(rgba_08_15)));
        __m512 rgba3
            = _mm512_cvtepi32_ps(_mm512_cvtepu16_epi32(_mm512_extracti64x4_epi64(rgba_08_15, 1)));
    ...
    static inline void
    StoreMasked(Type * out, __m512 r, __m512 g, __m512 b, __m512 a, uint32_t pixel_count)
    {
        const __m512 maxValue = _mm512_set1_ps((float)BitDepthInfo<BD>::maxValue);
        __m512 rgba0, rgba1, rgba2, rgba3;
...
template <> struct AVX512RGBAPack<BIT_DEPTH_UINT10>
{
    ...
    static inline void
    StoreMasked(uint16_t * out, __m512 r, __m512 g, __m512 b, __m512 a, uint32_t pixel_count)
    {
        AVX512RGBAPack16<BIT_DEPTH_UINT10>::StoreMasked(out, r, g, b, a, pixel_count);
    }
};

template <> struct AVX512RGBAPack<BIT_DEPTH_UINT12>
{
    static inline void Load(const uint16_t * in, __m512 & r, __m512 & g, __m512 & b, __m512 & a)
    {
...
template <> struct AVX512RGBAPack<BIT_DEPTH_UINT16>
{
    static inline void Load(const uint16_t * in, __m512 & r, __m512 & g, __m512 & b, __m512 & a)
    {
...
template <> struct AVX512RGBAPack<BIT_DEPTH_F16>
{
    ...
    static inline void Store(half * out, __m512 r, __m512 g, __m512 b, __m512 a)
    {
        ...
        __m512i rgba0i = _mm512_inserti64x4(
            _mm512_castsi256_si512(_mm512_cvtps_ph(rgba0, 0)),
            _mm512_cvtps_ph(rgba1, 0),
            1);
        __m512i rgba1i = _mm512_inserti64x4(
            _mm512_castsi256_si512(_mm512_cvtps_ph(rgba2, 0)),
            _mm512_cvtps_ph(rgba3, 0),
            1);
    ...
    static inline void
    StoreMasked(half * out, __m512 r, __m512 g, __m512 b, __m512 a, uint32_t pixel_count)
    {
        __m512 rgba0, rgba1, rgba2, rgba3;
...
template <> struct AVX512RGBAPack<BIT_DEPTH_F32>
{
    ...
    static inline void
    StoreMasked(float * out, __m512 r, __m512 g, __m512 b, __m512 a, uint32_t pixel_count)
    {
        __m512 rgba0, rgba1, rgba2, rgba3;
