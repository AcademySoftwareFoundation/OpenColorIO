...
static inline void sse2RGBATranspose_4x4(
    __m128 row0,
    __m128 row1,
    __m128 row2,
    __m128 row3,
    ...
    __m128 & out_a)
{
    ...
    out_g
        = _mm_movehl_ps(tmp2, tmp0); // Note movhlps swaps b with a which is different than unpckhpd
...
static inline __m128i sse2_cvtps_ph(__m128 a)
{
    ...
    x_exp           = _mm_castps_si128(
        _mm_max_ps(_mm_castsi128_ps(x_exp), _mm_castsi128_ps(exp_max))); // max(e, -14)
...
template <> struct SSE2RGBAPack<BIT_DEPTH_UINT8>
{
...
template <BitDepth BD> struct SSE2RGBAPack16
{
...
template <> struct SSE2RGBAPack<BIT_DEPTH_UINT10>
{
...
template <> struct SSE2RGBAPack<BIT_DEPTH_UINT12>
{
    static inline void Load(const uint16_t * in, __m128 & r, __m128 & g, __m128 & b, __m128 & a)
    {
...
template <> struct SSE2RGBAPack<BIT_DEPTH_UINT16>
{
    static inline void Load(const uint16_t * in, __m128 & r, __m128 & g, __m128 & b, __m128 & a)
    {
...
template <> struct SSE2RGBAPack<BIT_DEPTH_F16>
{
    static inline void Load(const half * in, __m128 & r, __m128 & g, __m128 & b, __m128 & a)
    {
        ...
        __m128 rgba1 = vreinterpretq_m128_f32(vcvt_f32_f16(
            vget_high_f16(vreinterpretq_f16_s64(vreinterpretq_s64_m128i(rgba_00_01)))));
        __m128 rgba2 = vreinterpretq_m128_f32(
            vcvt_f32_f16(vget_low_f16(vreinterpretq_f16_s64(vreinterpretq_s64_m128i(rgba_02_03)))));
        __m128 rgba3 = vreinterpretq_m128_f32(vcvt_f32_f16(
            vget_high_f16(vreinterpretq_f16_s64(vreinterpretq_s64_m128i(rgba_02_03)))));
#else
...
template <> struct SSE2RGBAPack<BIT_DEPTH_F32>
{
