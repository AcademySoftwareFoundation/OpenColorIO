    ...
    TransformDirection dir)
{
        ...
        = DynamicPtrCast<const GradingRGBCurveTransform>(transform))
    {
        ...
        ConstGradingHueCurveTransformRcPtr hueCurveTransform
...
std::ostream & operator<<(std::ostream & os, const Transform & transform)
{
        ...
        = dynamic_cast<const GradingRGBCurveTransform *>(t))
    {
        ...
        const GradingHueCurveTransform * hueCurveTransform
...
void CreateTransform(GroupTransformRcPtr & group, ConstOpRcPtr & op)
{
    ...
    else
    {
        const auto & ref = *op;
        std::ostringstream error;
        error << "CreateTransform from op. Missing implementation for: " << typeid(ref).name();
