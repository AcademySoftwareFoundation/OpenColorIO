...
public class ConfigTest extends TestCase {
    ...
    public void test_interface() {
        ...
        assertEquals(3, _cfge.getNumColourSpaces());
        assertEquals("lnh", _cfge.getColourSpaceNameByIndex(1));
        //public native ColourSpace getColourSpace(String name);
        assertEquals(0, _cfge.getIndexForColourSpace("foobar"));
        ...
        assertEquals("vd8", _cfge.getDisplayColourSpaceName("sRGB", "Film1D"));
        ...
        //_cfge.sanityCheck();
        //System.out.println(_cfge.getNumColourSpaces());
